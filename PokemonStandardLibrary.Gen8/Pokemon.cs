...
namespace PokemonStandardLibrary.Gen8
{
    public class Pokemon
    {
        ...
        public static Species GetPokemon(string name, ILanguage lang)
        {
            if (name.Contains('#'))
            {
                var sp = name.Split('#');
                return GetPokemon(sp[0].ToJPN(lang), sp[1].ToJPN(lang));
            }

            return GetPokemon(name.ToJPN(lang));
        }
        public static Species GetPokemon(string name, string form, ILanguage lang)
        {
            return GetPokemon(name.ToJPN(lang), form.ToJPN(lang));
        }
        public static IReadOnlyList<Species> GetAllForms(string name)
        {
            return formDex[name].ToArray();
        }
        public static IReadOnlyList<Species> GetAllForms(string name, ILanguage lang)
        {
        ...
        static Pokemon()
        {
            ...
            dexData.Add(new Species(63, -1, 31, -1, "ケーシィ", "", new uint[] { 25, 20, 15, 105, 55, 90 }, (PokeType.Psychic, PokeType.Non), new string[] { "シンクロ", "せいしんりょく", "マジックガード" }, GenderRatio.M3F1));
            dexData.Add(new Species(64, -1, 32, -1, "ユンゲラー", "", new uint[] { 40, 35, 30, 120, 70, 105 }, (PokeType.Psychic, PokeType.Non), new string[] { "シンクロ", "せいしんりょく", "マジックガード" }, GenderRatio.M3F1));
            dexData.Add(new Species(65, -1, 33, -1, "フーディン", "", new uint[] { 55, 50, 45, 135, 95, 120 }, (PokeType.Psychic, PokeType.Non), new string[] { "シンクロ", "せいしんりょく", "マジックガード" }, GenderRatio.M3F1));
            ...
            dexData.Add(new AnotherForm(122, 365, -1, 11, "バリヤード", "ガラル", new uint[] { 50, 65, 65, 90, 90, 100 }, (PokeType.Ice, PokeType.Psychic), new string[] { "やるき", "バリアフリー", "アイスボディ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(209, -1, -1, -1, "ブルー", "", new uint[] { 60, 80, 50, 40, 40, 30 }, (PokeType.Fairy, PokeType.Non), new string[] { "いかく", "にげあし", "びびり" }, GenderRatio.M1F3));
            dexData.Add(new Species(210, -1, -1, -1, "グランブル", "", new uint[] { 90, 120, 75, 60, 60, 45 }, (PokeType.Fairy, PokeType.Non), new string[] { "いかく", "にげあし", "びびり" }, GenderRatio.M1F3));
            ...
            dexData.Add(new AnotherForm(658, -1, -1, -1, "ゲッコウガ", "サトシ", new uint[] { 72, 145, 67, 153, 71, 132 }, (PokeType.Water, PokeType.Dark), new string[] { "きずなへんげ", "きずなへんげ", "きずなへんげ" }, GenderRatio.MaleOnly));
            ...
            dexData.Add(new Species(891, -1, 100, -1, "ダクマ", "", new uint[] { 60, 90, 60, 53, 50, 72 }, (PokeType.Fighting, PokeType.Non), new string[] { "せいしんりょく", "せいしんりょく", "せいしんりょく" }, GenderRatio.M7F1));
            dexData.Add(new AnotherForm(892, -1, 101, -1, "ウーラオス", "いちげき", new uint[] { 100, 130, 100, 63, 60, 97 }, (PokeType.Fighting, PokeType.Dark), new string[] { "ふかしのこぶし", "ふかしのこぶし", "ふかしのこぶし" }, GenderRatio.M7F1));
            dexData.Add(new AnotherForm(892, -1, 101, -1, "ウーラオス", "れんげき", new uint[] { 100, 130, 100, 63, 60, 97 }, (PokeType.Fighting, PokeType.Water), new string[] { "ふかしのこぶし", "ふかしのこぶし", "ふかしのこぶし" }, GenderRatio.M7F1));
