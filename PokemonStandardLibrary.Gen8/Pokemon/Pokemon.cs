...
namespace PokemonStandardLibrary.Gen8
{
    public sealed partial class Pokemon
    {
        ...
        static Pokemon()
        {
            ...
            dexData.Add(new Species(-1, -1, -1, -1, "Dummy", "Genderless", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Normal, PokeType.None), new string[] { "特性1", "特性2", "隠れ特性" }, GenderRatio.Genderless));
            dexData.Add(new Species(-1, -1, -1, -1, "Dummy", "MaleOnly", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Normal, PokeType.None), new string[] { "特性1", "特性2", "隠れ特性" }, GenderRatio.MaleOnly));
            dexData.Add(new Species(-1, -1, -1, -1, "Dummy", "M7F1", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Normal, PokeType.None), new string[] { "特性1", "特性2", "隠れ特性" }, GenderRatio.M7F1));
            dexData.Add(new Species(-1, -1, -1, -1, "Dummy", "M3F1", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Normal, PokeType.None), new string[] { "特性1", "特性2", "隠れ特性" }, GenderRatio.M3F1));
            dexData.Add(new Species(-1, -1, -1, -1, "Dummy", "M1F1", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Normal, PokeType.None), new string[] { "特性1", "特性2", "隠れ特性" }, GenderRatio.M1F1));
            dexData.Add(new Species(-1, -1, -1, -1, "Dummy", "M1F3", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Normal, PokeType.None), new string[] { "特性1", "特性2", "隠れ特性" }, GenderRatio.M1F3));
            dexData.Add(new Species(-1, -1, -1, -1, "Dummy", "FemaleOnly", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Normal, PokeType.None), new string[] { "特性1", "特性2", "隠れ特性" }, GenderRatio.FemaleOnly));
            ...
            dexData.Add(new Species(4, 378, -1, -1, "ヒトカゲ", "", new uint[] { 39, 52, 43, 60, 50, 65 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "サンパワー" }, GenderRatio.M7F1));
            dexData.Add(new Species(5, 379, -1, -1, "リザード", "", new uint[] { 58, 64, 58, 80, 65, 80 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "サンパワー" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(7, -1, 71, -1, "ゼニガメ", "", new uint[] { 44, 48, 65, 50, 64, 43 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "あめうけざら" }, GenderRatio.M7F1));
            dexData.Add(new Species(8, -1, 72, -1, "カメール", "", new uint[] { 59, 63, 80, 65, 80, 58 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "あめうけざら" }, GenderRatio.M7F1));
            dexData.Add(new Species(9, -1, 73, -1, "カメックス", "", new uint[] { 79, 83, 100, 85, 105, 78 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "あめうけざら" }, GenderRatio.M7F1));
            dexData.Add(new AnotherForm(9, -1, 73, -1, "カメックス", "キョダイ", new uint[] { 79, 83, 100, 85, 105, 78 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "あめうけざら" }, GenderRatio.M7F1));
            dexData.Add(new Species(10, 13, -1, -1, "キャタピー", "", new uint[] { 45, 30, 35, 20, 20, 45 }, (PokeType.Bug, PokeType.None), new string[] { "りんぷん", "りんぷん", "にげあし" }, GenderRatio.M1F1));
            dexData.Add(new Species(11, 14, -1, -1, "トランセル", "", new uint[] { 50, 20, 55, 25, 25, 30 }, (PokeType.Bug, PokeType.None), new string[] { "だっぴ", "だっぴ", "だっぴ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(19, -1, -1, -1, "コラッタ", "", new uint[] { 30, 56, 35, 25, 35, 72 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "こんじょう", "はりきり" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(20, -1, -1, -1, "ラッタ", "", new uint[] { 55, 81, 60, 50, 70, 97 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "こんじょう", "はりきり" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(23, -1, -1, -1, "アーボ", "", new uint[] { 35, 60, 44, 40, 54, 55 }, (PokeType.Poison, PokeType.None), new string[] { "いかく", "だっぴ", "きんちょうかん" }, GenderRatio.M1F1));
            dexData.Add(new Species(24, -1, -1, -1, "アーボック", "", new uint[] { 60, 95, 69, 65, 79, 80 }, (PokeType.Poison, PokeType.None), new string[] { "いかく", "だっぴ", "きんちょうかん" }, GenderRatio.M1F1));
            dexData.Add(new Species(25, 194, 85, -1, "ピカチュウ", "", new uint[] { 35, 55, 40, 50, 50, 90 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき", "ひらいしん" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(25, 194, 85, -1, "ピカチュウ", "キョダイ", new uint[] { 35, 55, 40, 50, 50, 90 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき", "ひらいしん" }, GenderRatio.M1F1));
            dexData.Add(new Species(26, 195, 86, -1, "ライチュウ", "", new uint[] { 60, 90, 55, 90, 80, 110 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき", "ひらいしん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(27, -1, 168, -1, "サンド", "", new uint[] { 50, 75, 85, 20, 30, 40 }, (PokeType.Ground, PokeType.None), new string[] { "すながくれ", "すながくれ", "すなかき" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(28, -1, 169, -1, "サンドパン", "", new uint[] { 75, 100, 110, 45, 55, 65 }, (PokeType.Ground, PokeType.None), new string[] { "すながくれ", "すながくれ", "すなかき" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(29, -1, -1, 65, "ニドラン♀", "", new uint[] { 55, 47, 52, 40, 40, 41 }, (PokeType.Poison, PokeType.None), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(30, -1, -1, 66, "ニドリーナ", "", new uint[] { 70, 62, 67, 55, 55, 56 }, (PokeType.Poison, PokeType.None), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.FemaleOnly));
            ...
            dexData.Add(new Species(32, -1, -1, 68, "ニドラン♂", "", new uint[] { 46, 57, 40, 40, 40, 50 }, (PokeType.Poison, PokeType.None), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.MaleOnly));
            dexData.Add(new Species(33, -1, -1, 69, "ニドリーノ", "", new uint[] { 61, 72, 57, 55, 55, 65 }, (PokeType.Poison, PokeType.None), new string[] { "どくのトゲ", "とうそうしん", "はりきり" }, GenderRatio.MaleOnly));
            ...
            dexData.Add(new Species(35, 255, -1, 44, "ピッピ", "", new uint[] { 70, 45, 48, 60, 65, 35 }, (PokeType.Fairy, PokeType.None), new string[] { "メロメロボディ", "マジックガード", "フレンドガード" }, GenderRatio.M1F3));
            dexData.Add(new Species(36, 256, -1, 45, "ピクシー", "", new uint[] { 95, 70, 73, 95, 90, 60 }, (PokeType.Fairy, PokeType.None), new string[] { "メロメロボディ", "マジックガード", "てんねん" }, GenderRatio.M1F3));
            dexData.Add(new Species(37, 68, -1, -1, "ロコン", "", new uint[] { 38, 41, 40, 50, 65, 65 }, (PokeType.Fire, PokeType.None), new string[] { "もらいび", "もらいび", "ひでり" }, GenderRatio.M1F3));
            dexData.Add(new AnotherForm(37, 68, -1, -1, "ロコン", "アローラ", new uint[] { 38, 41, 40, 50, 65, 65 }, (PokeType.Ice, PokeType.None), new string[] { "ゆきがくれ", "ゆきがくれ", "ゆきふらし" }, GenderRatio.M1F3));
            dexData.Add(new Species(38, 69, -1, -1, "キュウコン", "", new uint[] { 73, 76, 75, 81, 100, 100 }, (PokeType.Fire, PokeType.None), new string[] { "もらいび", "もらいび", "ひでり" }, GenderRatio.M1F3));
            ...
            dexData.Add(new Species(50, 164, -1, -1, "ディグダ", "", new uint[] { 10, 55, 25, 35, 45, 95 }, (PokeType.Ground, PokeType.None), new string[] { "すながくれ", "ありじごく", "すなのちから" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(51, 165, -1, -1, "ダグトリオ", "", new uint[] { 35, 100, 50, 50, 70, 120 }, (PokeType.Ground, PokeType.None), new string[] { "すながくれ", "ありじごく", "すなのちから" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(52, 182, -1, -1, "ニャース", "", new uint[] { 40, 45, 35, 40, 40, 90 }, (PokeType.Normal, PokeType.None), new string[] { "ものひろい", "テクニシャン", "きんちょうかん" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(52, 182, -1, -1, "ニャース", "キョダイ", new uint[] { 40, 45, 35, 40, 40, 90 }, (PokeType.Normal, PokeType.None), new string[] { "ものひろい", "テクニシャン", "きんちょうかん" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(52, 182, -1, -1, "ニャース", "アローラ", new uint[] { 40, 35, 35, 50, 40, 90 }, (PokeType.Dark, PokeType.None), new string[] { "ものひろい", "テクニシャン", "びびり" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(52, 182, -1, -1, "ニャース", "ガラル", new uint[] { 50, 65, 55, 40, 40, 40 }, (PokeType.Steel, PokeType.None), new string[] { "ものひろい", "かたいツメ", "きんちょうかん" }, GenderRatio.M1F1));
            dexData.Add(new Species(53, 184, -1, -1, "ペルシアン", "", new uint[] { 65, 70, 60, 65, 65, 115 }, (PokeType.Normal, PokeType.None), new string[] { "じゅうなん", "テクニシャン", "きんちょうかん" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(53, 184, -1, -1, "ペルシアン", "アローラ", new uint[] { 65, 60, 60, 75, 65, 115 }, (PokeType.Dark, PokeType.None), new string[] { "ファーコート", "テクニシャン", "びびり" }, GenderRatio.M1F1));
            dexData.Add(new Species(54, -1, 146, -1, "コダック", "", new uint[] { 50, 52, 48, 65, 50, 55 }, (PokeType.Water, PokeType.None), new string[] { "しめりけ", "ノーてんき", "すいすい" }, GenderRatio.M1F1));
            dexData.Add(new Species(55, -1, 147, -1, "ゴルダック", "", new uint[] { 80, 82, 78, 95, 80, 85 }, (PokeType.Water, PokeType.None), new string[] { "しめりけ", "ノーてんき", "すいすい" }, GenderRatio.M1F1));
            dexData.Add(new Species(56, -1, -1, -1, "マンキー", "", new uint[] { 40, 80, 35, 35, 45, 70 }, (PokeType.Fighting, PokeType.None), new string[] { "やるき", "いかりのつぼ", "まけんき" }, GenderRatio.M1F1));
            dexData.Add(new Species(57, -1, -1, -1, "オコリザル", "", new uint[] { 65, 105, 60, 60, 70, 95 }, (PokeType.Fighting, PokeType.None), new string[] { "やるき", "いかりのつぼ", "まけんき" }, GenderRatio.M1F1));
            dexData.Add(new Species(58, 70, -1, -1, "ガーディ", "", new uint[] { 55, 70, 45, 70, 50, 60 }, (PokeType.Fire, PokeType.None), new string[] { "いかく", "もらいび", "せいぎのこころ" }, GenderRatio.M3F1));
            dexData.Add(new Species(59, 71, -1, -1, "ウインディ", "", new uint[] { 90, 110, 80, 100, 80, 95 }, (PokeType.Fire, PokeType.None), new string[] { "いかく", "もらいび", "せいぎのこころ" }, GenderRatio.M3F1));
            dexData.Add(new Species(60, -1, 142, -1, "ニョロモ", "", new uint[] { 40, 50, 40, 40, 40, 90 }, (PokeType.Water, PokeType.None), new string[] { "ちょすい", "しめりけ", "すいすい" }, GenderRatio.M1F1));
            dexData.Add(new Species(61, -1, 143, -1, "ニョロゾ", "", new uint[] { 65, 65, 65, 50, 50, 90 }, (PokeType.Water, PokeType.None), new string[] { "ちょすい", "しめりけ", "すいすい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(63, -1, 31, -1, "ケーシィ", "", new uint[] { 25, 20, 15, 105, 55, 90 }, (PokeType.Psychic, PokeType.None), new string[] { "シンクロ", "せいしんりょく", "マジックガード" }, GenderRatio.M3F1));
            dexData.Add(new Species(64, -1, 32, -1, "ユンゲラー", "", new uint[] { 40, 35, 30, 120, 70, 105 }, (PokeType.Psychic, PokeType.None), new string[] { "シンクロ", "せいしんりょく", "マジックガード" }, GenderRatio.M3F1));
            dexData.Add(new Species(65, -1, 33, -1, "フーディン", "", new uint[] { 55, 50, 45, 135, 95, 120 }, (PokeType.Psychic, PokeType.None), new string[] { "シンクロ", "せいしんりょく", "マジックガード" }, GenderRatio.M3F1));
            dexData.Add(new Species(66, 138, -1, -1, "ワンリキー", "", new uint[] { 70, 80, 50, 35, 35, 35 }, (PokeType.Fighting, PokeType.None), new string[] { "こんじょう", "ノーガード", "ふくつのこころ" }, GenderRatio.M3F1));
            dexData.Add(new Species(67, 139, -1, -1, "ゴーリキー", "", new uint[] { 80, 100, 70, 50, 60, 45 }, (PokeType.Fighting, PokeType.None), new string[] { "こんじょう", "ノーガード", "ふくつのこころ" }, GenderRatio.M3F1));
            dexData.Add(new Species(68, 140, -1, -1, "カイリキー", "", new uint[] { 90, 130, 80, 65, 85, 55 }, (PokeType.Fighting, PokeType.None), new string[] { "こんじょう", "ノーガード", "ふくつのこころ" }, GenderRatio.M3F1));
            dexData.Add(new AnotherForm(68, 140, -1, -1, "カイリキー", "キョダイ", new uint[] { 90, 130, 80, 65, 85, 55 }, (PokeType.Fighting, PokeType.None), new string[] { "こんじょう", "ノーガード", "ふくつのこころ" }, GenderRatio.M3F1));
            ...
            dexData.Add(new Species(77, 333, -1, 105, "ポニータ", "", new uint[] { 50, 85, 55, 65, 65, 90 }, (PokeType.Fire, PokeType.None), new string[] { "にげあし", "もらいび", "ほのおのからだ" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(77, 333, -1, 105, "ポニータ", "ガラル", new uint[] { 50, 85, 55, 65, 65, 90 }, (PokeType.Psychic, PokeType.None), new string[] { "にげあし", "パステルベール", "きけんよち" }, GenderRatio.M1F1));
            dexData.Add(new Species(78, 334, -1, 106, "ギャロップ", "", new uint[] { 65, 100, 70, 80, 80, 105 }, (PokeType.Fire, PokeType.None), new string[] { "にげあし", "もらいび", "ほのおのからだ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new AnotherForm(79, -1, 1, -1, "ヤドン", "ガラル", new uint[] { 90, 65, 65, 40, 40, 15 }, (PokeType.Psychic, PokeType.None), new string[] { "くいしんぼう", "マイペース", "さいせいりょく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new AnotherForm(83, 218, -1, -1, "カモネギ", "ガラル", new uint[] { 52, 95, 55, 58, 62, 55 }, (PokeType.Fighting, PokeType.None), new string[] { "ふくつのこころ", "ふくつのこころ", "きもったま" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(86, -1, -1, -1, "パウワウ", "", new uint[] { 65, 45, 55, 45, 70, 45 }, (PokeType.Water, PokeType.None), new string[] { "あついしぼう", "うるおいボディ", "アイスボディ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(88, -1, -1, -1, "ベトベター", "", new uint[] { 80, 80, 50, 40, 50, 25 }, (PokeType.Poison, PokeType.None), new string[] { "あくしゅう", "ねんちゃく", "どくしゅ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(89, -1, -1, -1, "ベトベトン", "", new uint[] { 105, 105, 75, 65, 100, 50 }, (PokeType.Poison, PokeType.None), new string[] { "あくしゅう", "ねんちゃく", "どくしゅ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(90, 150, 131, -1, "シェルダー", "", new uint[] { 30, 65, 100, 45, 25, 40 }, (PokeType.Water, PokeType.None), new string[] { "シェルアーマー", "スキルリンク", "ぼうじん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(96, -1, -1, -1, "スリープ", "", new uint[] { 60, 48, 45, 43, 90, 42 }, (PokeType.Psychic, PokeType.None), new string[] { "ふみん", "よちむ", "せいしんりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(97, -1, -1, -1, "スリーパー", "", new uint[] { 85, 73, 70, 73, 115, 67 }, (PokeType.Psychic, PokeType.None), new string[] { "ふみん", "よちむ", "せいしんりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(98, 98, 38, -1, "クラブ", "", new uint[] { 30, 105, 90, 25, 25, 50 }, (PokeType.Water, PokeType.None), new string[] { "かいりきバサミ", "シェルアーマー", "ちからずく" }, GenderRatio.M1F1));
            dexData.Add(new Species(99, 99, 39, -1, "キングラー", "", new uint[] { 55, 130, 115, 50, 50, 75 }, (PokeType.Water, PokeType.None), new string[] { "かいりきバサミ", "シェルアーマー", "ちからずく" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(99, 99, -1, -1, "キングラー", "キョダイ", new uint[] { 55, 130, 115, 50, 50, 75 }, (PokeType.Water, PokeType.None), new string[] { "かいりきバサミ", "シェルアーマー", "ちからずく" }, GenderRatio.M1F1));
            dexData.Add(new Species(100, -1, -1, -1, "ビリリダマ", "", new uint[] { 40, 30, 50, 55, 55, 100 }, (PokeType.Electric, PokeType.None), new string[] { "ぼうおん", "せいでんき", "ゆうばく" }, GenderRatio.Genderless));
            dexData.Add(new Species(101, -1, -1, -1, "マルマイン", "", new uint[] { 60, 50, 70, 80, 80, 150 }, (PokeType.Electric, PokeType.None), new string[] { "ぼうおん", "せいでんき", "ゆうばく" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(104, -1, 170, -1, "カラカラ", "", new uint[] { 50, 50, 95, 40, 50, 35 }, (PokeType.Ground, PokeType.None), new string[] { "いしあたま", "ひらいしん", "カブトアーマー" }, GenderRatio.M1F1));
            dexData.Add(new Species(105, -1, 171, -1, "ガラガラ", "", new uint[] { 60, 80, 110, 50, 80, 45 }, (PokeType.Ground, PokeType.None), new string[] { "いしあたま", "ひらいしん", "カブトアーマー" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(106, 108, -1, -1, "サワムラー", "", new uint[] { 50, 120, 53, 35, 110, 87 }, (PokeType.Fighting, PokeType.None), new string[] { "じゅうなん", "すてみ", "かるわざ" }, GenderRatio.MaleOnly));
            dexData.Add(new Species(107, 109, -1, -1, "エビワラー", "", new uint[] { 50, 105, 79, 35, 110, 76 }, (PokeType.Fighting, PokeType.None), new string[] { "するどいめ", "てつのこぶし", "せいしんりょく" }, GenderRatio.MaleOnly));
            dexData.Add(new Species(108, -1, 54, -1, "ベロリンガ", "", new uint[] { 90, 55, 75, 60, 75, 30 }, (PokeType.Normal, PokeType.None), new string[] { "マイペース", "どんかん", "ノーてんき" }, GenderRatio.M1F1));
            dexData.Add(new Species(109, 250, -1, -1, "ドガース", "", new uint[] { 40, 65, 95, 60, 45, 35 }, (PokeType.Poison, PokeType.None), new string[] { "ふゆう", "かがくへんかガス", "あくしゅう" }, GenderRatio.M1F1));
            dexData.Add(new Species(110, 251, -1, -1, "マタドガス", "", new uint[] { 65, 90, 120, 85, 70, 60 }, (PokeType.Poison, PokeType.None), new string[] { "ふゆう", "かがくへんかガス", "あくしゅう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(113, -1, 7, -1, "ラッキー", "", new uint[] { 250, 5, 5, 35, 105, 50 }, (PokeType.Normal, PokeType.None), new string[] { "しぜんかいふく", "てんのめぐみ", "いやしのこころ" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(114, -1, 80, -1, "モンジャラ", "", new uint[] { 65, 55, 115, 100, 40, 60 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "リーフガード", "さいせいりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(115, -1, 172, -1, "ガルーラ", "", new uint[] { 105, 95, 80, 40, 80, 90 }, (PokeType.Normal, PokeType.None), new string[] { "はやおき", "きもったま", "せいしんりょく" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(116, -1, 198, -1, "タッツー", "", new uint[] { 30, 40, 70, 70, 25, 60 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "スナイパー", "しめりけ" }, GenderRatio.M1F1));
            dexData.Add(new Species(117, -1, 199, -1, "シードラ", "", new uint[] { 55, 65, 95, 95, 45, 85 }, (PokeType.Water, PokeType.None), new string[] { "どくのトゲ", "スナイパー", "しめりけ" }, GenderRatio.M1F1));
            dexData.Add(new Species(118, 146, 94, -1, "トサキント", "", new uint[] { 45, 67, 60, 35, 50, 63 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "みずのベール", "ひらいしん" }, GenderRatio.M1F1));
            dexData.Add(new Species(119, 147, 95, -1, "アズマオウ", "", new uint[] { 80, 92, 65, 65, 80, 68 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "みずのベール", "ひらいしん" }, GenderRatio.M1F1));
            dexData.Add(new Species(120, -1, 98, -1, "ヒトデマン", "", new uint[] { 30, 45, 55, 70, 55, 85 }, (PokeType.Water, PokeType.None), new string[] { "はっこう", "しぜんかいふく", "アナライズ" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(125, -1, -1, 16, "エレブー", "", new uint[] { 65, 83, 57, 95, 85, 105 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき", "やるき" }, GenderRatio.M3F1));
            dexData.Add(new Species(126, -1, -1, 19, "ブーバー", "", new uint[] { 65, 95, 57, 100, 85, 93 }, (PokeType.Fire, PokeType.None), new string[] { "ほのおのからだ", "ほのおのからだ", "やるき" }, GenderRatio.M3F1));
            dexData.Add(new Species(127, -1, 120, -1, "カイロス", "", new uint[] { 65, 125, 100, 55, 70, 85 }, (PokeType.Bug, PokeType.None), new string[] { "かいりきバサミ", "かたやぶり", "じしんかじょう" }, GenderRatio.M1F1));
            dexData.Add(new Species(128, -1, 116, -1, "ケンタロス", "", new uint[] { 75, 100, 95, 40, 70, 110 }, (PokeType.Normal, PokeType.None), new string[] { "いかく", "いかりのつぼ", "ちからずく" }, GenderRatio.MaleOnly));
            dexData.Add(new Species(129, 144, 42, 62, "コイキング", "", new uint[] { 20, 10, 55, 15, 20, 80 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい", "びびり" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(132, 373, 207, -1, "メタモン", "", new uint[] { 48, 48, 48, 48, 48, 48 }, (PokeType.Normal, PokeType.None), new string[] { "じゅうなん", "じゅうなん", "かわりもの" }, GenderRatio.Genderless));
            dexData.Add(new Species(133, 196, -1, 74, "イーブイ", "", new uint[] { 55, 55, 50, 45, 65, 55 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "てきおうりょく", "きけんよち" }, GenderRatio.M7F1));
            dexData.Add(new AnotherForm(133, 196, -1, 74, "イーブイ", "キョダイ", new uint[] { 55, 55, 50, 45, 65, 55 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "てきおうりょく", "きけんよち" }, GenderRatio.M7F1));
            dexData.Add(new Species(134, 197, -1, 75, "シャワーズ", "", new uint[] { 130, 65, 60, 110, 95, 65 }, (PokeType.Water, PokeType.None), new string[] { "ちょすい", "ちょすい", "うるおいボディ" }, GenderRatio.M7F1));
            dexData.Add(new Species(135, 198, -1, 76, "サンダース", "", new uint[] { 65, 65, 60, 110, 95, 130 }, (PokeType.Electric, PokeType.None), new string[] { "ちくでん", "ちくでん", "はやあし" }, GenderRatio.M7F1));
            dexData.Add(new Species(136, 199, -1, 77, "ブースター", "", new uint[] { 65, 130, 60, 95, 110, 65 }, (PokeType.Fire, PokeType.None), new string[] { "もらいび", "もらいび", "こんじょう" }, GenderRatio.M7F1));
            dexData.Add(new Species(137, -1, 208, -1, "ポリゴン", "", new uint[] { 65, 60, 70, 85, 75, 40 }, (PokeType.Normal, PokeType.None), new string[] { "トレース", "ダウンロード", "アナライズ" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(143, 261, -1, 173, "カビゴン", "", new uint[] { 160, 110, 65, 65, 110, 30 }, (PokeType.Normal, PokeType.None), new string[] { "めんえき", "あついしぼう", "くいしんぼう" }, GenderRatio.M7F1));
            dexData.Add(new AnotherForm(143, 261, -1, 173, "カビゴン", "キョダイ", new uint[] { 160, 110, 65, 65, 110, 30 }, (PokeType.Normal, PokeType.None), new string[] { "めんえき", "あついしぼう", "くいしんぼう" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(147, -1, -1, 194, "ミニリュウ", "", new uint[] { 41, 64, 45, 50, 50, 50 }, (PokeType.Dragon, PokeType.None), new string[] { "だっぴ", "だっぴ", "ふしぎなうろこ" }, GenderRatio.M1F1));
            dexData.Add(new Species(148, -1, -1, 195, "ハクリュー", "", new uint[] { 61, 84, 65, 70, 70, 70 }, (PokeType.Dragon, PokeType.None), new string[] { "だっぴ", "だっぴ", "ふしぎなうろこ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(150, -1, -1, -1, "ミュウツー", "", new uint[] { 106, 110, 90, 154, 90, 130 }, (PokeType.Psychic, PokeType.None), new string[] { "プレッシャー", "プレッシャー", "きんちょうかん" }, GenderRatio.Genderless));
            dexData.Add(new Species(151, -1, -1, -1, "ミュウ", "", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Psychic, PokeType.None), new string[] { "シンクロ", "シンクロ", "シンクロ" }, GenderRatio.Genderless));
            dexData.Add(new Species(152, -1, -1, -1, "チコリータ", "", new uint[] { 45, 49, 65, 49, 65, 45 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "リーフガード" }, GenderRatio.M7F1));
            dexData.Add(new Species(153, -1, -1, -1, "ベイリーフ", "", new uint[] { 60, 62, 80, 63, 80, 60 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "リーフガード" }, GenderRatio.M7F1));
            dexData.Add(new Species(154, -1, -1, -1, "メガニウム", "", new uint[] { 80, 82, 100, 83, 100, 80 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "リーフガード" }, GenderRatio.M7F1));
            dexData.Add(new Species(155, -1, -1, -1, "ヒノアラシ", "", new uint[] { 39, 52, 43, 60, 50, 65 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "もらいび" }, GenderRatio.M7F1));
            dexData.Add(new Species(156, -1, -1, -1, "マグマラシ", "", new uint[] { 58, 64, 58, 80, 65, 80 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "もらいび" }, GenderRatio.M7F1));
            dexData.Add(new Species(157, -1, -1, -1, "バクフーン", "", new uint[] { 78, 84, 78, 109, 85, 100 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "もらいび" }, GenderRatio.M7F1));
            dexData.Add(new Species(158, -1, -1, -1, "ワニノコ", "", new uint[] { 50, 65, 64, 44, 48, 43 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "ちからずく" }, GenderRatio.M7F1));
            dexData.Add(new Species(159, -1, -1, -1, "アリゲイツ", "", new uint[] { 65, 80, 80, 59, 63, 58 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "ちからずく" }, GenderRatio.M7F1));
            dexData.Add(new Species(160, -1, -1, -1, "オーダイル", "", new uint[] { 85, 105, 100, 79, 83, 78 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "ちからずく" }, GenderRatio.M7F1));
            dexData.Add(new Species(161, -1, -1, -1, "オタチ", "", new uint[] { 35, 46, 34, 35, 45, 20 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "するどいめ", "おみとおし" }, GenderRatio.M1F1));
            dexData.Add(new Species(162, -1, -1, -1, "オオタチ", "", new uint[] { 85, 76, 64, 45, 55, 90 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "するどいめ", "おみとおし" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(172, 193, 84, -1, "ピチュー", "", new uint[] { 20, 40, 15, 35, 35, 60 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき", "ひらいしん" }, GenderRatio.M1F1));
            dexData.Add(new Species(173, 254, -1, 43, "ピィ", "", new uint[] { 50, 25, 28, 45, 55, 15 }, (PokeType.Fairy, PokeType.None), new string[] { "メロメロボディ", "マジックガード", "フレンドガード" }, GenderRatio.M1F3));
            ...
            dexData.Add(new Species(175, 257, -1, -1, "トゲピー", "", new uint[] { 35, 20, 65, 40, 65, 20 }, (PokeType.Fairy, PokeType.None), new string[] { "はりきり", "てんのめぐみ", "きょううん" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(179, -1, -1, -1, "メリープ", "", new uint[] { 55, 40, 40, 65, 45, 35 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき", "プラス" }, GenderRatio.M1F1));
            dexData.Add(new Species(180, -1, -1, -1, "モココ", "", new uint[] { 70, 55, 55, 80, 60, 45 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき", "プラス" }, GenderRatio.M1F1));
            dexData.Add(new Species(181, -1, -1, -1, "デンリュウ", "", new uint[] { 90, 75, 85, 115, 90, 55 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき", "プラス" }, GenderRatio.M1F1));
            dexData.Add(new Species(182, 58, -1, -1, "キレイハナ", "", new uint[] { 75, 80, 95, 90, 100, 50 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "ようりょくそ", "いやしのこころ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(185, 253, -1, -1, "ウソッキー", "", new uint[] { 70, 100, 115, 30, 65, 30 }, (PokeType.Rock, PokeType.None), new string[] { "がんじょう", "いしあたま", "びびり" }, GenderRatio.M1F1));
            dexData.Add(new Species(186, -1, 145, -1, "ニョロトノ", "", new uint[] { 90, 75, 75, 90, 100, 70 }, (PokeType.Water, PokeType.None), new string[] { "ちょすい", "しめりけ", "あめふらし" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(190, -1, -1, -1, "エイパム", "", new uint[] { 55, 70, 55, 40, 55, 85 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "ものひろい", "スキルリンク" }, GenderRatio.M1F1));
            dexData.Add(new Species(191, -1, -1, -1, "ヒマナッツ", "", new uint[] { 30, 30, 30, 30, 30, 30 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "サンパワー", "はやおき" }, GenderRatio.M1F1));
            dexData.Add(new Species(192, -1, -1, -1, "キマワリ", "", new uint[] { 75, 75, 55, 105, 85, 30 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "サンパワー", "はやおき" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(196, 200, -1, 79, "エーフィ", "", new uint[] { 65, 65, 60, 130, 95, 110 }, (PokeType.Psychic, PokeType.None), new string[] { "シンクロ", "シンクロ", "マジックミラー" }, GenderRatio.M7F1));
            dexData.Add(new Species(197, 201, -1, 78, "ブラッキー", "", new uint[] { 95, 65, 110, 60, 130, 65 }, (PokeType.Dark, PokeType.None), new string[] { "シンクロ", "シンクロ", "せいしんりょく" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(200, -1, -1, -1, "ムウマ", "", new uint[] { 60, 60, 60, 85, 85, 85 }, (PokeType.Ghost, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            dexData.Add(new Species(201, -1, -1, -1, "アンノーン", "", new uint[] { 48, 72, 48, 72, 48, 48 }, (PokeType.Psychic, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            dexData.Add(new Species(202, 217, -1, -1, "ソーナンス", "", new uint[] { 190, 33, 58, 33, 58, 33 }, (PokeType.Psychic, PokeType.None), new string[] { "かげふみ", "かげふみ", "テレパシー" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(204, -1, -1, -1, "クヌギダマ", "", new uint[] { 50, 65, 90, 35, 35, 15 }, (PokeType.Bug, PokeType.None), new string[] { "がんじょう", "がんじょう", "ぼうじん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(206, -1, 52, -1, "ノコッチ", "", new uint[] { 100, 70, 70, 65, 65, 45 }, (PokeType.Normal, PokeType.None), new string[] { "てんのめぐみ", "にげあし", "びびり" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(209, -1, -1, -1, "ブルー", "", new uint[] { 60, 80, 50, 40, 40, 30 }, (PokeType.Fairy, PokeType.None), new string[] { "いかく", "にげあし", "びびり" }, GenderRatio.M1F3));
            dexData.Add(new Species(210, -1, -1, -1, "グランブル", "", new uint[] { 90, 120, 75, 60, 60, 45 }, (PokeType.Fairy, PokeType.None), new string[] { "いかく", "にげあし", "びびり" }, GenderRatio.M1F3));
            ...
            dexData.Add(new Species(216, -1, -1, -1, "ヒメグマ", "", new uint[] { 60, 80, 50, 50, 50, 40 }, (PokeType.Normal, PokeType.None), new string[] { "ものひろい", "はやあし", "みつあつめ" }, GenderRatio.M1F1));
            dexData.Add(new Species(217, -1, -1, -1, "リングマ", "", new uint[] { 90, 130, 75, 75, 75, 55 }, (PokeType.Normal, PokeType.None), new string[] { "こんじょう", "はやあし", "きんちょうかん" }, GenderRatio.M1F1));
            dexData.Add(new Species(218, -1, -1, -1, "マグマッグ", "", new uint[] { 40, 40, 40, 70, 40, 20 }, (PokeType.Fire, PokeType.None), new string[] { "マグマのよろい", "ほのおのからだ", "くだけるよろい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new AnotherForm(222, 236, -1, -1, "サニーゴ", "ガラル", new uint[] { 60, 55, 100, 65, 100, 30 }, (PokeType.Ghost, PokeType.None), new string[] { "くだけるよろい", "くだけるよろい", "のろわれボディ" }, GenderRatio.M1F3));
            dexData.Add(new Species(223, 148, 44, -1, "テッポウオ", "", new uint[] { 35, 65, 35, 65, 35, 65 }, (PokeType.Water, PokeType.None), new string[] { "はりきり", "スナイパー", "ムラっけ" }, GenderRatio.M1F1));
            dexData.Add(new Species(224, 149, 45, -1, "オクタン", "", new uint[] { 75, 105, 75, 105, 75, 45 }, (PokeType.Water, PokeType.None), new string[] { "きゅうばん", "スナイパー", "ムラっけ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(231, -1, -1, -1, "ゴマゾウ", "", new uint[] { 90, 60, 60, 40, 40, 40 }, (PokeType.Ground, PokeType.None), new string[] { "ものひろい", "ものひろい", "すながくれ" }, GenderRatio.M1F1));
            dexData.Add(new Species(232, -1, -1, -1, "ドンファン", "", new uint[] { 90, 120, 120, 60, 60, 50 }, (PokeType.Ground, PokeType.None), new string[] { "ものひろい", "ものひろい", "すながくれ" }, GenderRatio.M1F1));
            dexData.Add(new Species(233, -1, 209, -1, "ポリゴン2", "", new uint[] { 85, 80, 90, 105, 95, 60 }, (PokeType.Normal, PokeType.None), new string[] { "トレース", "ダウンロード", "アナライズ" }, GenderRatio.Genderless));
            dexData.Add(new Species(234, -1, -1, -1, "オドシシ", "", new uint[] { 73, 95, 62, 85, 65, 85 }, (PokeType.Normal, PokeType.None), new string[] { "いかく", "おみとおし", "そうしょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(235, -1, -1, -1, "ドーブル", "", new uint[] { 55, 20, 35, 20, 45, 75 }, (PokeType.Normal, PokeType.None), new string[] { "マイペース", "テクニシャン", "ムラっけ" }, GenderRatio.M1F1));
            dexData.Add(new Species(236, 107, -1, -1, "バルキー", "", new uint[] { 35, 35, 35, 35, 35, 35 }, (PokeType.Fighting, PokeType.None), new string[] { "こんじょう", "ふくつのこころ", "やるき" }, GenderRatio.MaleOnly));
            dexData.Add(new Species(237, 110, -1, -1, "カポエラー", "", new uint[] { 50, 95, 95, 35, 110, 70 }, (PokeType.Fighting, PokeType.None), new string[] { "いかく", "テクニシャン", "ふくつのこころ" }, GenderRatio.MaleOnly));
            ...
            dexData.Add(new Species(239, -1, -1, 15, "エレキッド", "", new uint[] { 45, 63, 37, 65, 55, 95 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき", "やるき" }, GenderRatio.M3F1));
            dexData.Add(new Species(240, -1, -1, 18, "ブビィ", "", new uint[] { 45, 75, 37, 70, 55, 83 }, (PokeType.Fire, PokeType.None), new string[] { "ほのおのからだ", "ほのおのからだ", "やるき" }, GenderRatio.M3F1));
            dexData.Add(new Species(241, -1, 117, -1, "ミルタンク", "", new uint[] { 95, 80, 105, 40, 70, 100 }, (PokeType.Normal, PokeType.None), new string[] { "あついしぼう", "きもったま", "そうしょく" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(242, -1, 8, -1, "ハピナス", "", new uint[] { 255, 10, 10, 75, 135, 55 }, (PokeType.Normal, PokeType.None), new string[] { "しぜんかいふく", "てんのめぐみ", "いやしのこころ" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(243, -1, -1, -1, "ライコウ", "", new uint[] { 90, 85, 75, 115, 100, 115 }, (PokeType.Electric, PokeType.None), new string[] { "プレッシャー", "プレッシャー", "せいしんりょく" }, GenderRatio.Genderless));
            dexData.Add(new Species(244, -1, -1, -1, "エンテイ", "", new uint[] { 115, 115, 85, 90, 75, 100 }, (PokeType.Fire, PokeType.None), new string[] { "プレッシャー", "プレッシャー", "せいしんりょく" }, GenderRatio.Genderless));
            dexData.Add(new Species(245, -1, -1, -1, "スイクン", "", new uint[] { 100, 75, 115, 90, 115, 85 }, (PokeType.Water, PokeType.None), new string[] { "プレッシャー", "プレッシャー", "せいしんりょく" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(252, -1, -1, -1, "キモリ", "", new uint[] { 40, 45, 35, 65, 55, 70 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "かるわざ" }, GenderRatio.M7F1));
            dexData.Add(new Species(253, -1, -1, -1, "ジュプトル", "", new uint[] { 50, 65, 45, 85, 65, 95 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "かるわざ" }, GenderRatio.M7F1));
            dexData.Add(new Species(254, -1, -1, -1, "ジュカイン", "", new uint[] { 70, 85, 65, 105, 85, 120 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "かるわざ" }, GenderRatio.M7F1));
            dexData.Add(new Species(255, -1, -1, -1, "アチャモ", "", new uint[] { 45, 60, 40, 70, 50, 45 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "かそく" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(258, -1, -1, -1, "ミズゴロウ", "", new uint[] { 50, 70, 50, 50, 50, 40 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "しめりけ" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(261, -1, -1, -1, "ポチエナ", "", new uint[] { 35, 55, 35, 30, 30, 35 }, (PokeType.Dark, PokeType.None), new string[] { "にげあし", "はやあし", "びびり" }, GenderRatio.M1F1));
            dexData.Add(new Species(262, -1, -1, -1, "グラエナ", "", new uint[] { 70, 90, 70, 60, 60, 70 }, (PokeType.Dark, PokeType.None), new string[] { "いかく", "はやあし", "じしんかじょう" }, GenderRatio.M1F1));
            dexData.Add(new Species(263, 31, -1, 71, "ジグザグマ", "", new uint[] { 38, 30, 41, 30, 41, 60 }, (PokeType.Normal, PokeType.None), new string[] { "ものひろい", "くいしんぼう", "はやあし" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(264, 32, -1, 72, "マッスグマ", "", new uint[] { 78, 70, 61, 50, 61, 100 }, (PokeType.Normal, PokeType.None), new string[] { "ものひろい", "くいしんぼう", "はやあし" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(265, -1, -1, -1, "ケムッソ", "", new uint[] { 45, 45, 35, 20, 30, 20 }, (PokeType.Bug, PokeType.None), new string[] { "りんぷん", "りんぷん", "にげあし" }, GenderRatio.M1F1));
            dexData.Add(new Species(266, -1, -1, -1, "カラサリス", "", new uint[] { 50, 35, 55, 25, 25, 15 }, (PokeType.Bug, PokeType.None), new string[] { "だっぴ", "だっぴ", "だっぴ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(268, -1, -1, -1, "マユルド", "", new uint[] { 50, 35, 55, 25, 25, 15 }, (PokeType.Bug, PokeType.None), new string[] { "だっぴ", "だっぴ", "だっぴ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(273, 39, -1, -1, "タネボー", "", new uint[] { 40, 40, 50, 30, 30, 30 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "はやおき", "わるいてぐせ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(285, -1, -1, -1, "キノココ", "", new uint[] { 60, 40, 60, 40, 60, 35 }, (PokeType.Grass, PokeType.None), new string[] { "ほうし", "ポイズンヒール", "はやあし" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(287, -1, -1, -1, "ナマケロ", "", new uint[] { 60, 60, 60, 35, 35, 30 }, (PokeType.Normal, PokeType.None), new string[] { "なまけ", "なまけ", "なまけ" }, GenderRatio.M1F1));
            dexData.Add(new Species(288, -1, -1, -1, "ヤルキモノ", "", new uint[] { 80, 80, 80, 55, 55, 90 }, (PokeType.Normal, PokeType.None), new string[] { "やるき", "やるき", "やるき" }, GenderRatio.M1F1));
            dexData.Add(new Species(289, -1, -1, -1, "ケッキング", "", new uint[] { 150, 160, 100, 95, 65, 100 }, (PokeType.Normal, PokeType.None), new string[] { "なまけ", "なまけ", "なまけ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(293, -1, 148, -1, "ゴニョニョ", "", new uint[] { 64, 51, 23, 51, 23, 28 }, (PokeType.Normal, PokeType.None), new string[] { "ぼうおん", "ぼうおん", "びびり" }, GenderRatio.M1F1));
            dexData.Add(new Species(294, -1, 149, -1, "ドゴーム", "", new uint[] { 84, 71, 43, 71, 43, 48 }, (PokeType.Normal, PokeType.None), new string[] { "ぼうおん", "ぼうおん", "きもったま" }, GenderRatio.M1F1));
            dexData.Add(new Species(295, -1, 150, -1, "バクオング", "", new uint[] { 104, 91, 63, 91, 73, 68 }, (PokeType.Normal, PokeType.None), new string[] { "ぼうおん", "ぼうおん", "きもったま" }, GenderRatio.M1F1));
            dexData.Add(new Species(296, -1, -1, -1, "マクノシタ", "", new uint[] { 72, 60, 30, 20, 30, 25 }, (PokeType.Fighting, PokeType.None), new string[] { "あついしぼう", "こんじょう", "ちからずく" }, GenderRatio.M3F1));
            dexData.Add(new Species(297, -1, -1, -1, "ハリテヤマ", "", new uint[] { 144, 120, 60, 40, 60, 50 }, (PokeType.Fighting, PokeType.None), new string[] { "あついしぼう", "こんじょう", "ちからずく" }, GenderRatio.M3F1));
            ...
            dexData.Add(new Species(299, -1, -1, -1, "ノズパス", "", new uint[] { 30, 45, 135, 45, 90, 30 }, (PokeType.Rock, PokeType.None), new string[] { "がんじょう", "じりょく", "すなのちから" }, GenderRatio.M1F1));
            dexData.Add(new Species(300, -1, -1, -1, "エネコ", "", new uint[] { 50, 45, 45, 35, 35, 50 }, (PokeType.Normal, PokeType.None), new string[] { "メロメロボディ", "ノーマルスキン", "ミラクルスキン" }, GenderRatio.M1F3));
            dexData.Add(new Species(301, -1, -1, -1, "エネコロロ", "", new uint[] { 70, 65, 65, 55, 55, 90 }, (PokeType.Normal, PokeType.None), new string[] { "メロメロボディ", "ノーマルスキン", "ミラクルスキン" }, GenderRatio.M1F3));
            ...
            dexData.Add(new Species(309, 66, -1, -1, "ラクライ", "", new uint[] { 40, 45, 40, 65, 40, 65 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "ひらいしん", "マイナス" }, GenderRatio.M1F1));
            dexData.Add(new Species(310, 67, -1, -1, "ライボルト", "", new uint[] { 70, 75, 60, 105, 60, 105 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "ひらいしん", "マイナス" }, GenderRatio.M1F1));
            dexData.Add(new Species(311, -1, -1, -1, "プラスル", "", new uint[] { 60, 50, 40, 85, 75, 95 }, (PokeType.Electric, PokeType.None), new string[] { "プラス", "プラス", "ひらいしん" }, GenderRatio.M1F1));
            dexData.Add(new Species(312, -1, -1, -1, "マイナン", "", new uint[] { 60, 40, 50, 75, 85, 95 }, (PokeType.Electric, PokeType.None), new string[] { "マイナス", "マイナス", "ちくでん" }, GenderRatio.M1F1));
            dexData.Add(new Species(313, -1, -1, -1, "バルビート", "", new uint[] { 65, 73, 75, 47, 85, 85 }, (PokeType.Bug, PokeType.None), new string[] { "はっこう", "むしのしらせ", "いたずらごころ" }, GenderRatio.MaleOnly));
            dexData.Add(new Species(314, -1, -1, -1, "イルミーゼ", "", new uint[] { 65, 47, 75, 73, 85, 85 }, (PokeType.Bug, PokeType.None), new string[] { "どんかん", "いろめがね", "いたずらごころ" }, GenderRatio.FemaleOnly));
            ...
            dexData.Add(new Species(316, -1, -1, -1, "ゴクリン", "", new uint[] { 70, 43, 53, 43, 53, 40 }, (PokeType.Poison, PokeType.None), new string[] { "ヘドロえき", "ねんちゃく", "くいしんぼう" }, GenderRatio.M1F1));
            dexData.Add(new Species(317, -1, -1, -1, "マルノーム", "", new uint[] { 100, 73, 83, 73, 83, 55 }, (PokeType.Poison, PokeType.None), new string[] { "ヘドロえき", "ねんちゃく", "くいしんぼう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(320, 356, 190, -1, "ホエルコ", "", new uint[] { 130, 70, 35, 70, 35, 60 }, (PokeType.Water, PokeType.None), new string[] { "みずのベール", "どんかん", "プレッシャー" }, GenderRatio.M1F1));
            dexData.Add(new Species(321, 357, 191, -1, "ホエルオー", "", new uint[] { 170, 90, 45, 90, 45, 60 }, (PokeType.Water, PokeType.None), new string[] { "みずのベール", "どんかん", "プレッシャー" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(324, 300, -1, -1, "コータス", "", new uint[] { 70, 85, 140, 85, 70, 20 }, (PokeType.Fire, PokeType.None), new string[] { "しろいけむり", "ひでり", "シェルアーマー" }, GenderRatio.M1F1));
            dexData.Add(new Species(325, -1, -1, -1, "バネブー", "", new uint[] { 60, 25, 35, 70, 80, 60 }, (PokeType.Psychic, PokeType.None), new string[] { "あついしぼう", "マイペース", "くいしんぼう" }, GenderRatio.M1F1));
            dexData.Add(new Species(326, -1, -1, -1, "ブーピッグ", "", new uint[] { 80, 45, 65, 90, 110, 80 }, (PokeType.Psychic, PokeType.None), new string[] { "あついしぼう", "マイペース", "くいしんぼう" }, GenderRatio.M1F1));
            dexData.Add(new Species(327, -1, -1, -1, "パッチール", "", new uint[] { 60, 60, 60, 60, 60, 60 }, (PokeType.Normal, PokeType.None), new string[] { "マイペース", "ちどりあし", "あまのじゃく" }, GenderRatio.M1F1));
            dexData.Add(new Species(328, 321, -1, -1, "ナックラー", "", new uint[] { 45, 100, 45, 45, 45, 10 }, (PokeType.Ground, PokeType.None), new string[] { "かいりきバサミ", "ありじごく", "ちからずく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(331, -1, -1, -1, "サボネア", "", new uint[] { 50, 85, 40, 85, 40, 35 }, (PokeType.Grass, PokeType.None), new string[] { "すながくれ", "すながくれ", "ちょすい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(335, -1, -1, -1, "ザングース", "", new uint[] { 73, 115, 60, 60, 60, 90 }, (PokeType.Normal, PokeType.None), new string[] { "めんえき", "めんえき", "どくぼうそう" }, GenderRatio.M1F1));
            dexData.Add(new Species(336, -1, -1, -1, "ハブネーク", "", new uint[] { 73, 100, 60, 100, 60, 65 }, (PokeType.Poison, PokeType.None), new string[] { "だっぴ", "だっぴ", "すりぬけ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(341, 102, 91, -1, "ヘイガニ", "", new uint[] { 43, 80, 65, 50, 35, 35 }, (PokeType.Water, PokeType.None), new string[] { "かいりきバサミ", "シェルアーマー", "てきおうりょく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(349, 152, -1, 188, "ヒンバス", "", new uint[] { 20, 15, 20, 10, 55, 80 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "どんかん", "てきおうりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(350, 153, -1, 189, "ミロカロス", "", new uint[] { 95, 60, 79, 100, 125, 81 }, (PokeType.Water, PokeType.None), new string[] { "ふしぎなうろこ", "かちき", "メロメロボディ" }, GenderRatio.M1F1));
            dexData.Add(new Species(351, -1, -1, -1, "ポワルン", "", new uint[] { 70, 70, 70, 70, 70, 70 }, (PokeType.Normal, PokeType.None), new string[] { "てんきや", "てんきや", "てんきや" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(351, -1, -1, -1, "ポワルン", "太陽", new uint[] { 70, 70, 70, 70, 70, 70 }, (PokeType.Fire, PokeType.None), new string[] { "てんきや", "てんきや", "てんきや" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(351, -1, -1, -1, "ポワルン", "雨水", new uint[] { 70, 70, 70, 70, 70, 70 }, (PokeType.Water, PokeType.None), new string[] { "てんきや", "てんきや", "てんきや" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(351, -1, -1, -1, "ポワルン", "雪雲", new uint[] { 70, 70, 70, 70, 70, 70 }, (PokeType.Ice, PokeType.None), new string[] { "てんきや", "てんきや", "てんきや" }, GenderRatio.M1F1));
            dexData.Add(new Species(352, -1, -1, -1, "カクレオン", "", new uint[] { 60, 90, 70, 60, 120, 40 }, (PokeType.Normal, PokeType.None), new string[] { "へんしょく", "へんしょく", "へんげんじざい" }, GenderRatio.M1F1));
            dexData.Add(new Species(353, -1, -1, -1, "カゲボウズ", "", new uint[] { 44, 75, 35, 63, 33, 45 }, (PokeType.Ghost, PokeType.None), new string[] { "ふみん", "おみとおし", "のろわれボディ" }, GenderRatio.M1F1));
            dexData.Add(new Species(354, -1, -1, -1, "ジュペッタ", "", new uint[] { 64, 115, 65, 83, 63, 65 }, (PokeType.Ghost, PokeType.None), new string[] { "ふみん", "おみとおし", "のろわれボディ" }, GenderRatio.M1F1));
            dexData.Add(new Species(355, 135, -1, -1, "ヨマワル", "", new uint[] { 20, 40, 90, 30, 90, 25 }, (PokeType.Ghost, PokeType.None), new string[] { "ふゆう", "ふゆう", "おみとおし" }, GenderRatio.M1F1));
            dexData.Add(new Species(356, 136, -1, -1, "サマヨール", "", new uint[] { 40, 70, 130, 60, 130, 25 }, (PokeType.Ghost, PokeType.None), new string[] { "プレッシャー", "プレッシャー", "おみとおし" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(358, -1, -1, -1, "チリーン", "", new uint[] { 75, 50, 80, 95, 90, 65 }, (PokeType.Psychic, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            dexData.Add(new Species(359, -1, -1, 107, "アブソル", "", new uint[] { 65, 130, 60, 75, 60, 75 }, (PokeType.Dark, PokeType.None), new string[] { "プレッシャー", "きょううん", "せいぎのこころ" }, GenderRatio.M1F1));
            dexData.Add(new Species(360, 216, -1, -1, "ソーナノ", "", new uint[] { 95, 23, 48, 23, 48, 23 }, (PokeType.Psychic, PokeType.None), new string[] { "かげふみ", "かげふみ", "テレパシー" }, GenderRatio.M1F1));
            dexData.Add(new Species(361, 79, -1, 25, "ユキワラシ", "", new uint[] { 50, 50, 50, 50, 50, 50 }, (PokeType.Ice, PokeType.None), new string[] { "せいしんりょく", "アイスボディ", "ムラっけ" }, GenderRatio.M1F1));
            dexData.Add(new Species(362, 80, -1, 26, "オニゴーリ", "", new uint[] { 80, 80, 80, 80, 80, 80 }, (PokeType.Ice, PokeType.None), new string[] { "せいしんりょく", "アイスボディ", "ムラっけ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(366, -1, -1, -1, "パールル", "", new uint[] { 35, 64, 85, 74, 55, 32 }, (PokeType.Water, PokeType.None), new string[] { "シェルアーマー", "シェルアーマー", "びびり" }, GenderRatio.M1F1));
            dexData.Add(new Species(367, -1, -1, -1, "ハンテール", "", new uint[] { 55, 104, 105, 94, 75, 52 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい", "みずのベール" }, GenderRatio.M1F1));
            dexData.Add(new Species(368, -1, -1, -1, "サクラビス", "", new uint[] { 55, 84, 105, 114, 75, 52 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい", "うるおいボディ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(370, -1, -1, -1, "ラブカス", "", new uint[] { 43, 30, 55, 40, 65, 97 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい", "うるおいボディ" }, GenderRatio.M1F3));
            dexData.Add(new Species(371, -1, -1, 113, "タツベイ", "", new uint[] { 45, 75, 60, 40, 30, 50 }, (PokeType.Dragon, PokeType.None), new string[] { "いしあたま", "いしあたま", "ちからずく" }, GenderRatio.M1F1));
            dexData.Add(new Species(372, -1, -1, 114, "コモルー", "", new uint[] { 65, 95, 100, 60, 50, 50 }, (PokeType.Dragon, PokeType.None), new string[] { "いしあたま", "いしあたま", "ぼうじん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(377, -1, -1, 197, "レジロック", "", new uint[] { 80, 100, 200, 50, 100, 50 }, (PokeType.Rock, PokeType.None), new string[] { "クリアボディ", "クリアボディ", "がんじょう" }, GenderRatio.Genderless));
            dexData.Add(new Species(378, -1, -1, 198, "レジアイス", "", new uint[] { 80, 50, 100, 100, 200, 50 }, (PokeType.Ice, PokeType.None), new string[] { "クリアボディ", "クリアボディ", "アイスボディ" }, GenderRatio.Genderless));
            dexData.Add(new Species(379, -1, -1, 199, "レジスチル", "", new uint[] { 80, 75, 150, 75, 150, 50 }, (PokeType.Steel, PokeType.None), new string[] { "クリアボディ", "クリアボディ", "ライトメタル" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(382, -1, -1, -1, "カイオーガ", "", new uint[] { 100, 100, 90, 150, 140, 90 }, (PokeType.Water, PokeType.None), new string[] { "あめふらし", "あめふらし", "あめふらし" }, GenderRatio.Genderless));
            dexData.Add(new Species(383, -1, -1, -1, "グラードン", "", new uint[] { 100, 150, 140, 100, 90, 90 }, (PokeType.Ground, PokeType.None), new string[] { "ひでり", "ひでり", "ひでり" }, GenderRatio.Genderless));
            ...
            dexData.Add(new AnotherForm(386, -1, -1, -1, "デオキシス", "ノーマル", new uint[] { 50, 150, 50, 150, 50, 150 }, (PokeType.Psychic, PokeType.None), new string[] { "プレッシャー", "プレッシャー", "プレッシャー" }, GenderRatio.Genderless));
            dexData.Add(new AnotherForm(386, -1, -1, -1, "デオキシス", "アタック", new uint[] { 50, 180, 20, 180, 20, 150 }, (PokeType.Psychic, PokeType.None), new string[] { "プレッシャー", "プレッシャー", "プレッシャー" }, GenderRatio.Genderless));
            dexData.Add(new AnotherForm(386, -1, -1, -1, "デオキシス", "ディフェンス", new uint[] { 50, 70, 160, 70, 160, 90 }, (PokeType.Psychic, PokeType.None), new string[] { "プレッシャー", "プレッシャー", "プレッシャー" }, GenderRatio.Genderless));
            dexData.Add(new AnotherForm(386, -1, -1, -1, "デオキシス", "スピード", new uint[] { 50, 95, 90, 95, 90, 180 }, (PokeType.Psychic, PokeType.None), new string[] { "プレッシャー", "プレッシャー", "プレッシャー" }, GenderRatio.Genderless));
            dexData.Add(new Species(387, -1, -1, -1, "ナエトル", "", new uint[] { 55, 68, 64, 45, 55, 31 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "シェルアーマー" }, GenderRatio.M7F1));
            dexData.Add(new Species(388, -1, -1, -1, "ハヤシガメ", "", new uint[] { 75, 89, 85, 55, 65, 36 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "シェルアーマー" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(390, -1, -1, -1, "ヒコザル", "", new uint[] { 44, 58, 44, 58, 44, 61 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "てつのこぶし" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(393, -1, -1, -1, "ポッチャマ", "", new uint[] { 53, 51, 53, 61, 56, 40 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "まけんき" }, GenderRatio.M7F1));
            dexData.Add(new Species(394, -1, -1, -1, "ポッタイシ", "", new uint[] { 64, 66, 68, 81, 76, 50 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "まけんき" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(399, -1, -1, -1, "ビッパ", "", new uint[] { 59, 45, 40, 35, 40, 31 }, (PokeType.Normal, PokeType.None), new string[] { "たんじゅん", "てんねん", "ムラっけ" }, GenderRatio.M1F1));
            dexData.Add(new Species(400, -1, -1, -1, "ビーダル", "", new uint[] { 79, 85, 60, 55, 60, 71 }, (PokeType.Normal, PokeType.None), new string[] { "たんじゅん", "てんねん", "ムラっけ" }, GenderRatio.M1F1));
            dexData.Add(new Species(401, -1, -1, -1, "コロボーシ", "", new uint[] { 37, 25, 41, 25, 41, 25 }, (PokeType.Bug, PokeType.None), new string[] { "だっぴ", "だっぴ", "にげあし" }, GenderRatio.M1F1));
            dexData.Add(new Species(402, -1, -1, -1, "コロトック", "", new uint[] { 77, 85, 51, 55, 51, 65 }, (PokeType.Bug, PokeType.None), new string[] { "むしのしらせ", "むしのしらせ", "テクニシャン" }, GenderRatio.M1F1));
            dexData.Add(new Species(403, -1, 25, -1, "コリンク", "", new uint[] { 45, 65, 34, 40, 34, 45 }, (PokeType.Electric, PokeType.None), new string[] { "とうそうしん", "いかく", "こんじょう" }, GenderRatio.M1F1));
            dexData.Add(new Species(404, -1, 26, -1, "ルクシオ", "", new uint[] { 60, 85, 49, 60, 49, 60 }, (PokeType.Electric, PokeType.None), new string[] { "とうそうしん", "いかく", "こんじょう" }, GenderRatio.M1F1));
            dexData.Add(new Species(405, -1, 27, -1, "レントラー", "", new uint[] { 80, 120, 79, 95, 79, 70 }, (PokeType.Electric, PokeType.None), new string[] { "とうそうしん", "いかく", "こんじょう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(408, -1, -1, -1, "ズガイドス", "", new uint[] { 67, 125, 40, 30, 30, 58 }, (PokeType.Rock, PokeType.None), new string[] { "かたやぶり", "かたやぶり", "ちからずく" }, GenderRatio.M7F1));
            dexData.Add(new Species(409, -1, -1, -1, "ラムパルド", "", new uint[] { 97, 165, 60, 65, 50, 58 }, (PokeType.Rock, PokeType.None), new string[] { "かたやぶり", "かたやぶり", "ちからずく" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(417, -1, -1, -1, "パチリス", "", new uint[] { 60, 45, 70, 45, 90, 95 }, (PokeType.Electric, PokeType.None), new string[] { "にげあし", "ものひろい", "ちくでん" }, GenderRatio.M1F1));
            dexData.Add(new Species(418, -1, -1, -1, "ブイゼル", "", new uint[] { 55, 65, 35, 60, 30, 85 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい", "みずのベール" }, GenderRatio.M1F1));
            dexData.Add(new Species(419, -1, -1, -1, "フローゼル", "", new uint[] { 85, 105, 55, 85, 50, 115 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい", "みずのベール" }, GenderRatio.M1F1));
            dexData.Add(new Species(420, 128, -1, -1, "チェリンボ", "", new uint[] { 45, 35, 45, 62, 53, 35 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "ようりょくそ", "ようりょくそ" }, GenderRatio.M1F1));
            dexData.Add(new Species(421, 129, -1, -1, "チェリム", "", new uint[] { 70, 60, 70, 87, 78, 85 }, (PokeType.Grass, PokeType.None), new string[] { "フラワーギフト", "フラワーギフト", "フラワーギフト" }, GenderRatio.M1F1));
            dexData.Add(new Species(422, 230, -1, -1, "カラナクシ", "", new uint[] { 76, 48, 48, 57, 62, 34 }, (PokeType.Water, PokeType.None), new string[] { "ねんちゃく", "よびみず", "すなのちから" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(424, -1, -1, -1, "エテボース", "", new uint[] { 75, 100, 66, 60, 66, 115 }, (PokeType.Normal, PokeType.None), new string[] { "テクニシャン", "ものひろい", "スキルリンク" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(427, -1, 4, -1, "ミミロル", "", new uint[] { 55, 66, 44, 44, 56, 85 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "ぶきよう", "じゅうなん" }, GenderRatio.M1F1));
            dexData.Add(new Species(428, -1, 5, -1, "ミミロップ", "", new uint[] { 65, 76, 84, 54, 96, 105 }, (PokeType.Normal, PokeType.None), new string[] { "メロメロボディ", "ぶきよう", "じゅうなん" }, GenderRatio.M1F1));
            dexData.Add(new Species(429, -1, -1, -1, "ムウマージ", "", new uint[] { 60, 60, 60, 105, 105, 105 }, (PokeType.Ghost, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(431, -1, -1, -1, "ニャルマー", "", new uint[] { 49, 55, 42, 42, 37, 85 }, (PokeType.Normal, PokeType.None), new string[] { "じゅうなん", "マイペース", "するどいめ" }, GenderRatio.M1F3));
            dexData.Add(new Species(432, -1, -1, -1, "ブニャット", "", new uint[] { 71, 82, 64, 64, 59, 112 }, (PokeType.Normal, PokeType.None), new string[] { "あついしぼう", "マイペース", "まけんき" }, GenderRatio.M1F3));
            dexData.Add(new Species(433, -1, -1, -1, "リーシャン", "", new uint[] { 45, 30, 50, 65, 50, 45 }, (PokeType.Psychic, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(438, 252, -1, -1, "ウソハチ", "", new uint[] { 50, 80, 95, 10, 45, 10 }, (PokeType.Rock, PokeType.None), new string[] { "がんじょう", "いしあたま", "びびり" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(440, -1, 6, -1, "ピンプク", "", new uint[] { 100, 5, 5, 15, 65, 30 }, (PokeType.Normal, PokeType.None), new string[] { "しぜんかいふく", "てんのめぐみ", "フレンドガード" }, GenderRatio.FemaleOnly));
            ...
            dexData.Add(new Species(446, 260, -1, 172, "ゴンベ", "", new uint[] { 135, 85, 40, 40, 85, 5 }, (PokeType.Normal, PokeType.None), new string[] { "ものひろい", "あついしぼう", "くいしんぼう" }, GenderRatio.M7F1));
            dexData.Add(new Species(447, 298, -1, 134, "リオル", "", new uint[] { 40, 70, 40, 35, 40, 60 }, (PokeType.Fighting, PokeType.None), new string[] { "ふくつのこころ", "せいしんりょく", "いたずらごころ" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(449, 314, -1, -1, "ヒポポタス", "", new uint[] { 68, 72, 78, 38, 42, 32 }, (PokeType.Ground, PokeType.None), new string[] { "すなおこし", "すなおこし", "すなのちから" }, GenderRatio.M1F1));
            dexData.Add(new Species(450, 315, -1, -1, "カバルドン", "", new uint[] { 108, 112, 118, 68, 72, 47 }, (PokeType.Ground, PokeType.None), new string[] { "すなおこし", "すなおこし", "すなのちから" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(455, -1, -1, -1, "マスキッパ", "", new uint[] { 74, 100, 72, 90, 72, 46 }, (PokeType.Grass, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            dexData.Add(new Species(456, -1, -1, -1, "ケイコウオ", "", new uint[] { 49, 49, 56, 49, 61, 66 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "よびみず", "みずのベール" }, GenderRatio.M1F1));
            dexData.Add(new Species(457, -1, -1, -1, "ネオラント", "", new uint[] { 69, 69, 76, 69, 86, 91 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "よびみず", "みずのベール" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(463, -1, 55, -1, "ベロベルト", "", new uint[] { 110, 85, 95, 80, 95, 50 }, (PokeType.Normal, PokeType.None), new string[] { "マイペース", "どんかん", "ノーてんき" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(465, -1, 81, -1, "モジャンボ", "", new uint[] { 100, 100, 125, 110, 50, 50 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "リーフガード", "さいせいりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(466, -1, -1, 17, "エレキブル", "", new uint[] { 75, 123, 67, 95, 85, 95 }, (PokeType.Electric, PokeType.None), new string[] { "でんきエンジン", "でんきエンジン", "やるき" }, GenderRatio.M3F1));
            dexData.Add(new Species(467, -1, -1, 20, "ブーバーン", "", new uint[] { 75, 95, 67, 125, 95, 83 }, (PokeType.Fire, PokeType.None), new string[] { "ほのおのからだ", "ほのおのからだ", "やるき" }, GenderRatio.M3F1));
            ...
            dexData.Add(new Species(470, 202, -1, 81, "リーフィア", "", new uint[] { 65, 110, 130, 60, 65, 95 }, (PokeType.Grass, PokeType.None), new string[] { "リーフガード", "リーフガード", "ようりょくそ" }, GenderRatio.M7F1));
            dexData.Add(new Species(471, 203, -1, 80, "グレイシア", "", new uint[] { 65, 60, 110, 130, 95, 65 }, (PokeType.Ice, PokeType.None), new string[] { "ゆきがくれ", "ゆきがくれ", "アイスボディ" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(474, -1, 210, -1, "ポリゴンZ", "", new uint[] { 85, 80, 70, 135, 75, 90 }, (PokeType.Normal, PokeType.None), new string[] { "てきおうりょく", "ダウンロード", "アナライズ" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(477, 137, -1, -1, "ヨノワール", "", new uint[] { 45, 100, 135, 65, 135, 45 }, (PokeType.Ghost, PokeType.None), new string[] { "プレッシャー", "プレッシャー", "おみとおし" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(480, -1, -1, -1, "ユクシー", "", new uint[] { 75, 75, 130, 75, 130, 95 }, (PokeType.Psychic, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            dexData.Add(new Species(481, -1, -1, -1, "エムリット", "", new uint[] { 80, 105, 105, 105, 105, 80 }, (PokeType.Psychic, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            dexData.Add(new Species(482, -1, -1, -1, "アグノム", "", new uint[] { 75, 125, 70, 125, 70, 115 }, (PokeType.Psychic, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(486, -1, -1, -1, "レジギガス", "", new uint[] { 110, 160, 110, 80, 110, 100 }, (PokeType.Normal, PokeType.None), new string[] { "スロースタート", "スロースタート", "スロースタート" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(488, -1, -1, -1, "クレセリア", "", new uint[] { 120, 70, 120, 75, 130, 85 }, (PokeType.Psychic, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(489, -1, -1, -1, "フィオネ", "", new uint[] { 80, 80, 80, 80, 80, 80 }, (PokeType.Water, PokeType.None), new string[] { "うるおいボディ", "うるおいボディ", "うるおいボディ" }, GenderRatio.Genderless));
            dexData.Add(new Species(490, -1, -1, -1, "マナフィ", "", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Water, PokeType.None), new string[] { "うるおいボディ", "うるおいボディ", "うるおいボディ" }, GenderRatio.Genderless));
            dexData.Add(new Species(491, -1, -1, -1, "ダークライ", "", new uint[] { 70, 90, 90, 135, 90, 125 }, (PokeType.Dark, PokeType.None), new string[] { "ナイトメア", "ナイトメア", "ナイトメア" }, GenderRatio.Genderless));
            dexData.Add(new AnotherForm(492, -1, -1, -1, "シェイミ", "ランド", new uint[] { 100, 100, 100, 100, 100, 100 }, (PokeType.Grass, PokeType.None), new string[] { "しぜんかいふく", "しぜんかいふく", "しぜんかいふく" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(493, -1, -1, -1, "アルセウス", "", new uint[] { 120, 120, 120, 120, 120, 120 }, (PokeType.Normal, PokeType.None), new string[] { "マルチタイプ", "マルチタイプ", "マルチタイプ" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(495, -1, -1, -1, "ツタージャ", "", new uint[] { 45, 45, 55, 45, 55, 63 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "あまのじゃく" }, GenderRatio.M7F1));
            dexData.Add(new Species(496, -1, -1, -1, "ジャノビー", "", new uint[] { 60, 60, 75, 60, 75, 83 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "あまのじゃく" }, GenderRatio.M7F1));
            dexData.Add(new Species(497, -1, -1, -1, "ジャローダ", "", new uint[] { 75, 75, 95, 75, 95, 113 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "あまのじゃく" }, GenderRatio.M7F1));
            dexData.Add(new Species(498, -1, -1, -1, "ポカブ", "", new uint[] { 65, 63, 45, 45, 45, 45 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "あついしぼう" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(501, -1, -1, -1, "ミジュマル", "", new uint[] { 55, 55, 45, 63, 45, 45 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "シェルアーマー" }, GenderRatio.M7F1));
            dexData.Add(new Species(502, -1, -1, -1, "フタチマル", "", new uint[] { 75, 75, 60, 83, 60, 60 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "シェルアーマー" }, GenderRatio.M7F1));
            dexData.Add(new Species(503, -1, -1, -1, "ダイケンキ", "", new uint[] { 95, 100, 85, 108, 70, 70 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "シェルアーマー" }, GenderRatio.M7F1));
            dexData.Add(new Species(504, -1, -1, -1, "ミネズミ", "", new uint[] { 45, 55, 39, 35, 39, 42 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "するどいめ", "アナライズ" }, GenderRatio.M1F1));
            dexData.Add(new Species(505, -1, -1, -1, "ミルホッグ", "", new uint[] { 60, 85, 69, 60, 69, 77 }, (PokeType.Normal, PokeType.None), new string[] { "はっこう", "するどいめ", "アナライズ" }, GenderRatio.M1F1));
            dexData.Add(new Species(506, -1, 113, -1, "ヨーテリー", "", new uint[] { 45, 60, 45, 25, 45, 55 }, (PokeType.Normal, PokeType.None), new string[] { "やるき", "ものひろい", "にげあし" }, GenderRatio.M1F1));
            dexData.Add(new Species(507, -1, 114, -1, "ハーデリア", "", new uint[] { 65, 80, 65, 35, 65, 60 }, (PokeType.Normal, PokeType.None), new string[] { "いかく", "すなかき", "きもったま" }, GenderRatio.M1F1));
            dexData.Add(new Species(508, -1, 115, -1, "ムーランド", "", new uint[] { 85, 110, 90, 45, 90, 80 }, (PokeType.Normal, PokeType.None), new string[] { "いかく", "すなかき", "きもったま" }, GenderRatio.M1F1));
            dexData.Add(new Species(509, 44, -1, -1, "チョロネコ", "", new uint[] { 41, 50, 37, 50, 37, 66 }, (PokeType.Dark, PokeType.None), new string[] { "じゅうなん", "かるわざ", "いたずらごころ" }, GenderRatio.M1F1));
            dexData.Add(new Species(510, 45, -1, -1, "レパルダス", "", new uint[] { 64, 88, 50, 88, 50, 106 }, (PokeType.Dark, PokeType.None), new string[] { "じゅうなん", "かるわざ", "いたずらごころ" }, GenderRatio.M1F1));
            dexData.Add(new Species(511, -1, -1, -1, "ヤナップ", "", new uint[] { 50, 53, 48, 53, 48, 64 }, (PokeType.Grass, PokeType.None), new string[] { "くいしんぼう", "くいしんぼう", "しんりょく" }, GenderRatio.M7F1));
            dexData.Add(new Species(512, -1, -1, -1, "ヤナッキー", "", new uint[] { 75, 98, 63, 98, 63, 101 }, (PokeType.Grass, PokeType.None), new string[] { "くいしんぼう", "くいしんぼう", "しんりょく" }, GenderRatio.M7F1));
            dexData.Add(new Species(513, -1, -1, -1, "バオップ", "", new uint[] { 50, 53, 48, 53, 48, 64 }, (PokeType.Fire, PokeType.None), new string[] { "くいしんぼう", "くいしんぼう", "もうか" }, GenderRatio.M7F1));
            dexData.Add(new Species(514, -1, -1, -1, "バオッキー", "", new uint[] { 75, 98, 63, 98, 63, 101 }, (PokeType.Fire, PokeType.None), new string[] { "くいしんぼう", "くいしんぼう", "もうか" }, GenderRatio.M7F1));
            dexData.Add(new Species(515, -1, -1, -1, "ヒヤップ", "", new uint[] { 50, 53, 48, 53, 48, 64 }, (PokeType.Water, PokeType.None), new string[] { "くいしんぼう", "くいしんぼう", "げきりゅう" }, GenderRatio.M7F1));
            dexData.Add(new Species(516, -1, -1, -1, "ヒヤッキー", "", new uint[] { 75, 98, 63, 98, 63, 101 }, (PokeType.Water, PokeType.None), new string[] { "くいしんぼう", "くいしんぼう", "げきりゅう" }, GenderRatio.M7F1));
            dexData.Add(new Species(517, 90, -1, -1, "ムンナ", "", new uint[] { 76, 25, 45, 67, 55, 24 }, (PokeType.Psychic, PokeType.None), new string[] { "よちむ", "シンクロ", "テレパシー" }, GenderRatio.M1F1));
            dexData.Add(new Species(518, 91, -1, -1, "ムシャーナ", "", new uint[] { 116, 55, 85, 107, 95, 29 }, (PokeType.Psychic, PokeType.None), new string[] { "よちむ", "シンクロ", "テレパシー" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(522, -1, -1, -1, "シママ", "", new uint[] { 45, 60, 32, 50, 32, 76 }, (PokeType.Electric, PokeType.None), new string[] { "ひらいしん", "でんきエンジン", "そうしょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(523, -1, -1, -1, "ゼブライカ", "", new uint[] { 75, 100, 63, 80, 63, 116 }, (PokeType.Electric, PokeType.None), new string[] { "ひらいしん", "でんきエンジン", "そうしょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(524, 168, 154, -1, "ダンゴロ", "", new uint[] { 55, 75, 85, 25, 25, 15 }, (PokeType.Rock, PokeType.None), new string[] { "がんじょう", "くだけるよろい", "すなのちから" }, GenderRatio.M1F1));
            dexData.Add(new Species(525, 169, 155, -1, "ガントル", "", new uint[] { 70, 105, 105, 50, 40, 20 }, (PokeType.Rock, PokeType.None), new string[] { "がんじょう", "くだけるよろい", "すなのちから" }, GenderRatio.M1F1));
            dexData.Add(new Species(526, 170, 156, -1, "ギガイアス", "", new uint[] { 85, 135, 130, 60, 80, 25 }, (PokeType.Rock, PokeType.None), new string[] { "がんじょう", "すなおこし", "すなのちから" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(529, 166, -1, -1, "モグリュー", "", new uint[] { 60, 85, 40, 30, 45, 68 }, (PokeType.Ground, PokeType.None), new string[] { "すなかき", "すなのちから", "かたやぶり" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(531, -1, -1, 21, "タブンネ", "", new uint[] { 103, 60, 86, 60, 86, 50 }, (PokeType.Normal, PokeType.None), new string[] { "いやしのこころ", "さいせいりょく", "ぶきよう" }, GenderRatio.M1F1));
            dexData.Add(new Species(532, 171, -1, 57, "ドッコラー", "", new uint[] { 75, 80, 55, 25, 35, 35 }, (PokeType.Fighting, PokeType.None), new string[] { "こんじょう", "ちからずく", "てつのこぶし" }, GenderRatio.M3F1));
            dexData.Add(new Species(533, 172, -1, 58, "ドテッコツ", "", new uint[] { 85, 105, 85, 40, 50, 40 }, (PokeType.Fighting, PokeType.None), new string[] { "こんじょう", "ちからずく", "てつのこぶし" }, GenderRatio.M3F1));
            dexData.Add(new Species(534, 173, -1, 59, "ローブシン", "", new uint[] { 105, 140, 95, 55, 65, 45 }, (PokeType.Fighting, PokeType.None), new string[] { "こんじょう", "ちからずく", "てつのこぶし" }, GenderRatio.M3F1));
            dexData.Add(new Species(535, 132, -1, -1, "オタマロ", "", new uint[] { 50, 50, 40, 50, 40, 64 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "うるおいボディ", "ちょすい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(538, 248, -1, -1, "ナゲキ", "", new uint[] { 120, 100, 85, 30, 85, 45 }, (PokeType.Fighting, PokeType.None), new string[] { "こんじょう", "せいしんりょく", "かたやぶり" }, GenderRatio.MaleOnly));
            dexData.Add(new Species(539, 249, -1, -1, "ダゲキ", "", new uint[] { 75, 125, 75, 30, 75, 85 }, (PokeType.Fighting, PokeType.None), new string[] { "がんじょう", "せいしんりょく", "かたやぶり" }, GenderRatio.MaleOnly));
            ...
            dexData.Add(new Species(548, -1, 201, -1, "チュリネ", "", new uint[] { 45, 35, 50, 70, 50, 30 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "マイペース", "リーフガード" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(549, -1, 202, -1, "ドレディア", "", new uint[] { 70, 60, 75, 110, 75, 90 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "マイペース", "リーフガード" }, GenderRatio.FemaleOnly));
            dexData.Add(new AnotherForm(550, 154, -1, 64, "バスラオ", "あか", new uint[] { 70, 92, 65, 80, 55, 98 }, (PokeType.Water, PokeType.None), new string[] { "すてみ", "てきおうりょく", "かたやぶり" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(550, 154, -1, 64, "バスラオ", "あお", new uint[] { 70, 92, 65, 80, 55, 98 }, (PokeType.Water, PokeType.None), new string[] { "いしあたま", "てきおうりょく", "かたやぶり" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(554, 367, -1, 103, "ダルマッカ", "", new uint[] { 70, 90, 45, 15, 45, 50 }, (PokeType.Fire, PokeType.None), new string[] { "はりきり", "はりきり", "せいしんりょく" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(554, 367, -1, 103, "ダルマッカ", "ガラル", new uint[] { 70, 90, 45, 15, 45, 50 }, (PokeType.Ice, PokeType.None), new string[] { "はりきり", "はりきり", "せいしんりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(555, 368, -1, 104, "ヒヒダルマ", "", new uint[] { 105, 140, 55, 30, 55, 95 }, (PokeType.Fire, PokeType.None), new string[] { "ちからずく", "ちからずく", "ダルマモード" }, GenderRatio.M1F1));
            ...
            dexData.Add(new AnotherForm(555, 368, -1, 104, "ヒヒダルマ", "ガラル", new uint[] { 105, 140, 55, 30, 55, 95 }, (PokeType.Ice, PokeType.None), new string[] { "ごりむちゅう", "ごりむちゅう", "ダルマモード" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(556, 296, -1, -1, "マラカッチ", "", new uint[] { 75, 86, 67, 106, 67, 60 }, (PokeType.Grass, PokeType.None), new string[] { "ちょすい", "ようりょくそ", "よびみず" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(562, 327, -1, -1, "デスマス", "", new uint[] { 38, 30, 85, 55, 65, 30 }, (PokeType.Ghost, PokeType.None), new string[] { "ミイラ", "ミイラ", "ミイラ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(563, 329, -1, -1, "デスカーン", "", new uint[] { 58, 50, 145, 95, 105, 30 }, (PokeType.Ghost, PokeType.None), new string[] { "ミイラ", "ミイラ", "ミイラ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(568, 157, -1, -1, "ヤブクロン", "", new uint[] { 50, 50, 62, 40, 62, 65 }, (PokeType.Poison, PokeType.None), new string[] { "あくしゅう", "ねんちゃく", "ゆうばく" }, GenderRatio.M1F1));
            dexData.Add(new Species(569, 158, -1, -1, "ダストダス", "", new uint[] { 80, 95, 82, 60, 82, 75 }, (PokeType.Poison, PokeType.None), new string[] { "あくしゅう", "くだけるよろい", "ゆうばく" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(569, 158, -1, -1, "ダストダス", "キョダイ", new uint[] { 80, 95, 82, 60, 82, 75 }, (PokeType.Poison, PokeType.None), new string[] { "あくしゅう", "くだけるよろい", "ゆうばく" }, GenderRatio.M1F1));
            dexData.Add(new Species(570, -1, 87, -1, "ゾロア", "", new uint[] { 40, 65, 40, 80, 40, 65 }, (PokeType.Dark, PokeType.None), new string[] { "イリュージョン", "イリュージョン", "イリュージョン" }, GenderRatio.M7F1));
            dexData.Add(new Species(571, -1, 88, -1, "ゾロアーク", "", new uint[] { 60, 105, 60, 120, 60, 105 }, (PokeType.Dark, PokeType.None), new string[] { "イリュージョン", "イリュージョン", "イリュージョン" }, GenderRatio.M7F1));
            dexData.Add(new Species(572, 50, -1, -1, "チラーミィ", "", new uint[] { 55, 50, 40, 40, 40, 75 }, (PokeType.Normal, PokeType.None), new string[] { "メロメロボディ", "テクニシャン", "スキルリンク" }, GenderRatio.M1F3));
            dexData.Add(new Species(573, 51, -1, -1, "チラチーノ", "", new uint[] { 75, 95, 60, 65, 60, 115 }, (PokeType.Normal, PokeType.None), new string[] { "メロメロボディ", "テクニシャン", "スキルリンク" }, GenderRatio.M1F3));
            dexData.Add(new Species(574, 267, -1, 51, "ゴチム", "", new uint[] { 45, 30, 50, 55, 65, 45 }, (PokeType.Psychic, PokeType.None), new string[] { "おみとおし", "かちき", "かげふみ" }, GenderRatio.M1F3));
            dexData.Add(new Species(575, 268, -1, 52, "ゴチミル", "", new uint[] { 60, 45, 70, 75, 85, 55 }, (PokeType.Psychic, PokeType.None), new string[] { "おみとおし", "かちき", "かげふみ" }, GenderRatio.M1F3));
            dexData.Add(new Species(576, 269, -1, 53, "ゴチルゼル", "", new uint[] { 70, 55, 95, 95, 110, 65 }, (PokeType.Psychic, PokeType.None), new string[] { "おみとおし", "かちき", "かげふみ" }, GenderRatio.M1F3));
            dexData.Add(new Species(577, 270, -1, 54, "ユニラン", "", new uint[] { 45, 30, 40, 105, 50, 20 }, (PokeType.Psychic, PokeType.None), new string[] { "ぼうじん", "マジックガード", "さいせいりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(578, 271, -1, 55, "ダブラン", "", new uint[] { 65, 40, 50, 125, 60, 30 }, (PokeType.Psychic, PokeType.None), new string[] { "ぼうじん", "マジックガード", "さいせいりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(579, 272, -1, 56, "ランクルス", "", new uint[] { 110, 65, 75, 125, 85, 30 }, (PokeType.Psychic, PokeType.None), new string[] { "ぼうじん", "マジックガード", "さいせいりょく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(582, 72, -1, 22, "バニプッチ", "", new uint[] { 36, 50, 50, 65, 60, 44 }, (PokeType.Ice, PokeType.None), new string[] { "アイスボディ", "ゆきがくれ", "くだけるよろい" }, GenderRatio.M1F1));
            dexData.Add(new Species(583, 73, -1, 23, "バニリッチ", "", new uint[] { 51, 65, 65, 80, 75, 59 }, (PokeType.Ice, PokeType.None), new string[] { "アイスボディ", "ゆきがくれ", "くだけるよろい" }, GenderRatio.M1F1));
            dexData.Add(new Species(584, 74, -1, 24, "バイバニラ", "", new uint[] { 71, 95, 85, 110, 95, 79 }, (PokeType.Ice, PokeType.None), new string[] { "アイスボディ", "ゆきふらし", "くだけるよろい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(588, 273, 66, 95, "カブルモ", "", new uint[] { 50, 75, 45, 40, 45, 60 }, (PokeType.Bug, PokeType.None), new string[] { "むしのしらせ", "だっぴ", "ノーガード" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(594, -1, -1, -1, "ママンボウ", "", new uint[] { 165, 75, 80, 40, 45, 65 }, (PokeType.Water, PokeType.None), new string[] { "いやしのこころ", "うるおいボディ", "さいせいりょく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(599, 113, -1, -1, "ギアル", "", new uint[] { 40, 55, 70, 45, 60, 30 }, (PokeType.Steel, PokeType.None), new string[] { "プラス", "マイナス", "クリアボディ" }, GenderRatio.Genderless));
            dexData.Add(new Species(600, 114, -1, -1, "ギギアル", "", new uint[] { 60, 80, 95, 70, 85, 50 }, (PokeType.Steel, PokeType.None), new string[] { "プラス", "マイナス", "クリアボディ" }, GenderRatio.Genderless));
            dexData.Add(new Species(601, 115, -1, -1, "ギギギアル", "", new uint[] { 60, 100, 115, 70, 85, 90 }, (PokeType.Steel, PokeType.None), new string[] { "プラス", "マイナス", "クリアボディ" }, GenderRatio.Genderless));
            dexData.Add(new Species(602, -1, -1, -1, "シビシラス", "", new uint[] { 35, 55, 40, 45, 40, 60 }, (PokeType.Electric, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            dexData.Add(new Species(603, -1, -1, -1, "シビビール", "", new uint[] { 65, 85, 70, 75, 70, 40 }, (PokeType.Electric, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            dexData.Add(new Species(604, -1, -1, -1, "シビルドン", "", new uint[] { 85, 115, 80, 105, 80, 50 }, (PokeType.Electric, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            dexData.Add(new Species(605, 277, -1, -1, "リグレー", "", new uint[] { 55, 55, 55, 85, 55, 30 }, (PokeType.Psychic, PokeType.None), new string[] { "テレパシー", "シンクロ", "アナライズ" }, GenderRatio.M1F1));
            dexData.Add(new Species(606, 278, -1, -1, "オーベム", "", new uint[] { 75, 75, 75, 125, 95, 40 }, (PokeType.Psychic, PokeType.None), new string[] { "テレパシー", "シンクロ", "アナライズ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(610, 324, -1, -1, "キバゴ", "", new uint[] { 46, 87, 60, 30, 40, 57 }, (PokeType.Dragon, PokeType.None), new string[] { "とうそうしん", "かたやぶり", "きんちょうかん" }, GenderRatio.M1F1));
            dexData.Add(new Species(611, 325, -1, -1, "オノンド", "", new uint[] { 66, 117, 70, 40, 50, 67 }, (PokeType.Dragon, PokeType.None), new string[] { "とうそうしん", "かたやぶり", "きんちょうかん" }, GenderRatio.M1F1));
            dexData.Add(new Species(612, 326, -1, -1, "オノノクス", "", new uint[] { 76, 147, 90, 60, 70, 97 }, (PokeType.Dragon, PokeType.None), new string[] { "とうそうしん", "かたやぶり", "きんちょうかん" }, GenderRatio.M1F1));
            dexData.Add(new Species(613, 279, -1, 121, "クマシュン", "", new uint[] { 55, 70, 40, 60, 40, 40 }, (PokeType.Ice, PokeType.None), new string[] { "ゆきがくれ", "ゆきかき", "びびり" }, GenderRatio.M1F1));
            dexData.Add(new Species(614, 280, -1, 122, "ツンベアー", "", new uint[] { 95, 130, 80, 70, 80, 50 }, (PokeType.Ice, PokeType.None), new string[] { "ゆきがくれ", "ゆきかき", "すいすい" }, GenderRatio.M1F1));
            dexData.Add(new Species(615, -1, -1, 30, "フリージオ", "", new uint[] { 80, 50, 50, 95, 135, 105 }, (PokeType.Ice, PokeType.None), new string[] { "ふゆう", "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            dexData.Add(new Species(616, 275, 64, 97, "チョボマキ", "", new uint[] { 50, 40, 85, 40, 65, 25 }, (PokeType.Bug, PokeType.None), new string[] { "うるおいボディ", "シェルアーマー", "ぼうじん" }, GenderRatio.M1F1));
            dexData.Add(new Species(617, 276, 65, 98, "アギルダー", "", new uint[] { 80, 70, 40, 100, 60, 145 }, (PokeType.Bug, PokeType.None), new string[] { "うるおいボディ", "ねんちゃく", "かるわざ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(619, -1, 163, -1, "コジョフー", "", new uint[] { 45, 85, 50, 55, 50, 65 }, (PokeType.Fighting, PokeType.None), new string[] { "せいしんりょく", "さいせいりょく", "すてみ" }, GenderRatio.M1F1));
            dexData.Add(new Species(620, -1, 164, -1, "コジョンド", "", new uint[] { 65, 125, 60, 95, 60, 105 }, (PokeType.Fighting, PokeType.None), new string[] { "せいしんりょく", "さいせいりょく", "すてみ" }, GenderRatio.M1F1));
            dexData.Add(new Species(621, -1, 63, 119, "クリムガン", "", new uint[] { 77, 120, 90, 60, 90, 48 }, (PokeType.Dragon, PokeType.None), new string[] { "さめはだ", "ちからずく", "かたやぶり" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(626, -1, 53, -1, "バッフロン", "", new uint[] { 95, 110, 95, 40, 95, 55 }, (PokeType.Normal, PokeType.None), new string[] { "すてみ", "そうしょく", "ぼうおん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(631, 317, -1, 102, "クイタラン", "", new uint[] { 85, 97, 66, 105, 66, 65 }, (PokeType.Fire, PokeType.None), new string[] { "くいしんぼう", "もらいび", "しろいけむり" }, GenderRatio.M1F1));
            ...
            dexData.Add(new AnotherForm(641, -1, -1, -1, "トルネロス", "化身", new uint[] { 79, 115, 70, 125, 80, 111 }, (PokeType.Flying, PokeType.None), new string[] { "いたずらごころ", "いたずらごころ", "まけんき" }, GenderRatio.MaleOnly));
            dexData.Add(new AnotherForm(641, -1, -1, -1, "トルネロス", "霊獣", new uint[] { 79, 100, 80, 110, 90, 121 }, (PokeType.Flying, PokeType.None), new string[] { "さいせいりょく", "さいせいりょく", "さいせいりょく" }, GenderRatio.MaleOnly));
            ...
            dexData.Add(new Species(650, -1, -1, -1, "ハリマロン", "", new uint[] { 56, 61, 65, 48, 45, 38 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "ぼうだん" }, GenderRatio.M7F1));
            dexData.Add(new Species(651, -1, -1, -1, "ハリボーグ", "", new uint[] { 61, 78, 95, 56, 58, 57 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "ぼうだん" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(653, -1, -1, -1, "フォッコ", "", new uint[] { 40, 45, 40, 62, 60, 60 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "マジシャン" }, GenderRatio.M7F1));
            dexData.Add(new Species(654, -1, -1, -1, "テールナー", "", new uint[] { 59, 59, 58, 90, 70, 73 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "マジシャン" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(656, -1, -1, -1, "ケロマツ", "", new uint[] { 41, 56, 40, 62, 44, 71 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "へんげんじざい" }, GenderRatio.M7F1));
            dexData.Add(new Species(657, -1, -1, -1, "ゲコガシラ", "", new uint[] { 54, 63, 52, 83, 56, 97 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "へんげんじざい" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(659, 48, -1, -1, "ホルビー", "", new uint[] { 38, 36, 38, 32, 36, 57 }, (PokeType.Normal, PokeType.None), new string[] { "ものひろい", "ほおぶくろ", "ちからもち" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(664, -1, -1, -1, "コフキムシ", "", new uint[] { 38, 35, 40, 27, 25, 35 }, (PokeType.Bug, PokeType.None), new string[] { "りんぷん", "ふくがん", "フレンドガード" }, GenderRatio.M1F1));
            dexData.Add(new Species(665, -1, -1, -1, "コフーライ", "", new uint[] { 45, 22, 60, 27, 30, 29 }, (PokeType.Bug, PokeType.None), new string[] { "だっぴ", "だっぴ", "フレンドガード" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(669, -1, -1, -1, "フラベベ", "", new uint[] { 44, 38, 39, 61, 79, 42 }, (PokeType.Fairy, PokeType.None), new string[] { "フラワーベール", "フラワーベール", "きょうせい" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(670, -1, -1, -1, "フラエッテ", "", new uint[] { 54, 45, 47, 75, 98, 52 }, (PokeType.Fairy, PokeType.None), new string[] { "フラワーベール", "フラワーベール", "きょうせい" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(671, -1, -1, -1, "フラージェス", "", new uint[] { 78, 65, 68, 112, 154, 75 }, (PokeType.Fairy, PokeType.None), new string[] { "フラワーベール", "フラワーベール", "きょうせい" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(672, -1, -1, -1, "メェークル", "", new uint[] { 66, 65, 48, 62, 57, 52 }, (PokeType.Grass, PokeType.None), new string[] { "そうしょく", "そうしょく", "くさのけがわ" }, GenderRatio.M1F1));
            dexData.Add(new Species(673, -1, -1, -1, "ゴーゴート", "", new uint[] { 123, 100, 62, 97, 81, 68 }, (PokeType.Grass, PokeType.None), new string[] { "そうしょく", "そうしょく", "くさのけがわ" }, GenderRatio.M1F1));
            dexData.Add(new Species(674, 111, -1, -1, "ヤンチャム", "", new uint[] { 67, 82, 62, 46, 48, 43 }, (PokeType.Fighting, PokeType.None), new string[] { "てつのこぶし", "かたやぶり", "きもったま" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(676, -1, -1, -1, "トリミアン", "", new uint[] { 75, 80, 60, 65, 90, 102 }, (PokeType.Normal, PokeType.None), new string[] { "ファーコート", "ファーコート", "ファーコート" }, GenderRatio.M1F1));
            dexData.Add(new Species(677, 208, -1, -1, "ニャスパー", "", new uint[] { 62, 48, 54, 63, 60, 68 }, (PokeType.Psychic, PokeType.None), new string[] { "するどいめ", "すりぬけ", "マイペース" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(678, 209, -1, -1, "ニャオニクス", "♂", new uint[] { 74, 48, 76, 83, 81, 104 }, (PokeType.Psychic, PokeType.None), new string[] { "するどいめ", "すりぬけ", "いたずらごころ" }, GenderRatio.MaleOnly));
            dexData.Add(new AnotherForm(678, 209, -1, -1, "ニャオニクス", "♀", new uint[] { 74, 48, 76, 83, 81, 104 }, (PokeType.Psychic, PokeType.None), new string[] { "するどいめ", "すりぬけ", "かちき" }, GenderRatio.FemaleOnly));
            ...
            dexData.Add(new Species(682, 212, -1, -1, "シュシュプ", "", new uint[] { 78, 52, 60, 63, 65, 23 }, (PokeType.Fairy, PokeType.None), new string[] { "いやしのこころ", "いやしのこころ", "アロマベール" }, GenderRatio.M1F1));
            dexData.Add(new Species(683, 213, -1, -1, "フレフワン", "", new uint[] { 101, 72, 72, 99, 89, 29 }, (PokeType.Fairy, PokeType.None), new string[] { "いやしのこころ", "いやしのこころ", "アロマベール" }, GenderRatio.M1F1));
            dexData.Add(new Species(684, 210, -1, -1, "ペロッパフ", "", new uint[] { 62, 48, 66, 59, 57, 49 }, (PokeType.Fairy, PokeType.None), new string[] { "スイートベール", "スイートベール", "かるわざ" }, GenderRatio.M1F1));
            dexData.Add(new Species(685, 211, -1, -1, "ペロリーム", "", new uint[] { 82, 80, 86, 85, 75, 72 }, (PokeType.Fairy, PokeType.None), new string[] { "スイートベール", "スイートベール", "かるわざ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(692, -1, 196, -1, "ウデッポウ", "", new uint[] { 50, 53, 62, 58, 63, 44 }, (PokeType.Water, PokeType.None), new string[] { "メガランチャー", "メガランチャー", "メガランチャー" }, GenderRatio.M1F1));
            dexData.Add(new Species(693, -1, 197, -1, "ブロスター", "", new uint[] { 71, 73, 88, 120, 89, 59 }, (PokeType.Water, PokeType.None), new string[] { "メガランチャー", "メガランチャー", "メガランチャー" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(700, 204, -1, 82, "ニンフィア", "", new uint[] { 95, 65, 65, 110, 130, 60 }, (PokeType.Fairy, PokeType.None), new string[] { "メロメロボディ", "メロメロボディ", "フェアリースキン" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(704, 389, 60, -1, "ヌメラ", "", new uint[] { 45, 50, 35, 55, 75, 40 }, (PokeType.Dragon, PokeType.None), new string[] { "そうしょく", "うるおいボディ", "ぬめぬめ" }, GenderRatio.M1F1));
            dexData.Add(new Species(705, 390, 61, -1, "ヌメイル", "", new uint[] { 68, 75, 53, 83, 113, 60 }, (PokeType.Dragon, PokeType.None), new string[] { "そうしょく", "うるおいボディ", "ぬめぬめ" }, GenderRatio.M1F1));
            dexData.Add(new Species(706, 391, 62, -1, "ヌメルゴン", "", new uint[] { 90, 100, 70, 110, 150, 80 }, (PokeType.Dragon, PokeType.None), new string[] { "そうしょく", "うるおいボディ", "ぬめぬめ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(712, 358, -1, 142, "カチコール", "", new uint[] { 55, 69, 85, 32, 35, 28 }, (PokeType.Ice, PokeType.None), new string[] { "マイペース", "アイスボディ", "がんじょう" }, GenderRatio.M1F1));
            dexData.Add(new Species(713, 359, -1, 143, "クレベース", "", new uint[] { 95, 117, 184, 44, 46, 28 }, (PokeType.Ice, PokeType.None), new string[] { "マイペース", "アイスボディ", "がんじょう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(716, -1, -1, -1, "ゼルネアス", "", new uint[] { 126, 131, 95, 131, 98, 99 }, (PokeType.Fairy, PokeType.None), new string[] { "フェアリーオーラ", "フェアリーオーラ", "フェアリーオーラ" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(725, -1, -1, -1, "ニャビー", "", new uint[] { 45, 65, 40, 60, 40, 70 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "いかく" }, GenderRatio.M7F1));
            dexData.Add(new Species(726, -1, -1, -1, "ニャヒート", "", new uint[] { 65, 85, 50, 80, 50, 90 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "いかく" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(728, -1, -1, -1, "アシマリ", "", new uint[] { 50, 54, 54, 66, 56, 40 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "うるおいボイス" }, GenderRatio.M7F1));
            dexData.Add(new Species(729, -1, -1, -1, "オシャマリ", "", new uint[] { 60, 69, 69, 91, 81, 50 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "うるおいボイス" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(734, -1, -1, -1, "ヤングース", "", new uint[] { 48, 70, 30, 30, 30, 45 }, (PokeType.Normal, PokeType.None), new string[] { "はりこみ", "がんじょうあご", "てきおうりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(735, -1, -1, -1, "デカグース", "", new uint[] { 88, 110, 60, 55, 60, 45 }, (PokeType.Normal, PokeType.None), new string[] { "はりこみ", "がんじょうあご", "てきおうりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(736, 16, -1, -1, "アゴジムシ", "", new uint[] { 47, 62, 45, 55, 45, 46 }, (PokeType.Bug, PokeType.None), new string[] { "むしのしらせ", "むしのしらせ", "むしのしらせ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(739, -1, -1, -1, "マケンカニ", "", new uint[] { 47, 82, 57, 42, 47, 63 }, (PokeType.Fighting, PokeType.None), new string[] { "かいりきバサミ", "てつのこぶし", "いかりのつぼ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(744, -1, 157, -1, "イワンコ", "", new uint[] { 45, 65, 40, 30, 40, 60 }, (PokeType.Rock, PokeType.None), new string[] { "するどいめ", "やるき", "ふくつのこころ" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(744, -1, 157, -1, "イワンコ", "夕", new uint[] { 45, 65, 40, 30, 40, 60 }, (PokeType.Rock, PokeType.None), new string[] { "マイペース", "マイペース", "マイペース" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(745, -1, 158, -1, "ルガルガン", "昼", new uint[] { 75, 115, 65, 55, 65, 112 }, (PokeType.Rock, PokeType.None), new string[] { "するどいめ", "すなかき", "ふくつのこころ" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(745, -1, 158, -1, "ルガルガン", "夜", new uint[] { 85, 115, 75, 55, 75, 82 }, (PokeType.Rock, PokeType.None), new string[] { "するどいめ", "やるき", "ノーガード" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(745, -1, 158, -1, "ルガルガン", "夕", new uint[] { 75, 117, 65, 55, 65, 110 }, (PokeType.Rock, PokeType.None), new string[] { "かたいツメ", "かたいツメ", "かたいツメ" }, GenderRatio.M1F1));
            dexData.Add(new Species(746, 155, 110, -1, "ヨワシ", "単独", new uint[] { 45, 20, 20, 25, 25, 40 }, (PokeType.Water, PokeType.None), new string[] { "ぎょぐん", "ぎょぐん", "ぎょぐん" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(746, 155, 110, -1, "ヨワシ", "群れ", new uint[] { 45, 140, 130, 140, 135, 30 }, (PokeType.Water, PokeType.None), new string[] { "ぎょぐん", "ぎょぐん", "ぎょぐん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(749, 84, -1, -1, "ドロバンコ", "", new uint[] { 70, 100, 70, 45, 55, 45 }, (PokeType.Ground, PokeType.None), new string[] { "マイペース", "じきゅうりょく", "せいしんりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(750, 85, -1, -1, "バンバドロ", "", new uint[] { 100, 125, 100, 55, 85, 35 }, (PokeType.Ground, PokeType.None), new string[] { "マイペース", "じきゅうりょく", "せいしんりょく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(753, -1, 17, -1, "カリキリ", "", new uint[] { 40, 55, 35, 50, 35, 35 }, (PokeType.Grass, PokeType.None), new string[] { "リーフガード", "リーフガード", "あまのじゃく" }, GenderRatio.M1F1));
            dexData.Add(new Species(754, -1, 18, -1, "ラランテス", "", new uint[] { 70, 105, 90, 80, 90, 45 }, (PokeType.Grass, PokeType.None), new string[] { "リーフガード", "リーフガード", "あまのじゃく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(761, 52, -1, -1, "アマカジ", "", new uint[] { 42, 30, 38, 30, 38, 32 }, (PokeType.Grass, PokeType.None), new string[] { "リーフガード", "どんかん", "スイートベール" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(762, 53, -1, -1, "アママイコ", "", new uint[] { 52, 40, 48, 40, 48, 62 }, (PokeType.Grass, PokeType.None), new string[] { "リーフガード", "どんかん", "スイートベール" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(763, 54, -1, -1, "アマージョ", "", new uint[] { 72, 120, 98, 50, 98, 72 }, (PokeType.Grass, PokeType.None), new string[] { "リーフガード", "じょおうのいげん", "スイートベール" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(764, -1, 79, -1, "キュワワー", "", new uint[] { 51, 52, 90, 82, 110, 100 }, (PokeType.Fairy, PokeType.None), new string[] { "フラワーベール", "ヒーリングシフト", "しぜんかいふく" }, GenderRatio.M1F3));
            ...
            dexData.Add(new Species(766, 343, 90, -1, "ナゲツケサル", "", new uint[] { 100, 120, 90, 40, 60, 80 }, (PokeType.Fighting, PokeType.None), new string[] { "レシーバー", "レシーバー", "まけんき" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(771, 156, -1, -1, "ナマコブシ", "", new uint[] { 55, 60, 130, 30, 130, 5 }, (PokeType.Water, PokeType.None), new string[] { "とびだすなかみ", "とびだすなかみ", "てんねん" }, GenderRatio.M1F1));
            dexData.Add(new Species(772, 381, -1, -1, "タイプ:ヌル", "", new uint[] { 95, 95, 95, 95, 95, 59 }, (PokeType.Normal, PokeType.None), new string[] { "カブトアーマー", "カブトアーマー", "カブトアーマー" }, GenderRatio.Genderless));
            dexData.Add(new Species(773, 382, -1, -1, "シルヴァディ", "", new uint[] { 95, 95, 95, 95, 95, 95 }, (PokeType.Normal, PokeType.None), new string[] { "ARシステム", "ARシステム", "ARシステム" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(775, -1, -1, -1, "ネッコアラ", "", new uint[] { 65, 115, 65, 75, 95, 65 }, (PokeType.Normal, PokeType.None), new string[] { "ぜったいねむり", "ぜったいねむり", "ぜったいねむり" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(782, 392, 165, -1, "ジャラコ", "", new uint[] { 45, 55, 65, 45, 45, 45 }, (PokeType.Dragon, PokeType.None), new string[] { "ぼうだん", "ぼうおん", "ぼうじん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(789, -1, -1, -1, "コスモッグ", "", new uint[] { 43, 29, 31, 29, 31, 37 }, (PokeType.Psychic, PokeType.None), new string[] { "てんねん", "てんねん", "てんねん" }, GenderRatio.Genderless));
            dexData.Add(new Species(790, -1, -1, -1, "コスモウム", "", new uint[] { 43, 29, 131, 29, 131, 37 }, (PokeType.Psychic, PokeType.None), new string[] { "がんじょう", "がんじょう", "がんじょう" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(796, -1, -1, -1, "デンジュモク", "", new uint[] { 83, 89, 71, 173, 71, 83 }, (PokeType.Electric, PokeType.None), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(800, -1, -1, -1, "ネクロズマ", "", new uint[] { 97, 107, 101, 127, 89, 79 }, (PokeType.Psychic, PokeType.None), new string[] { "プリズムアーマー", "プリズムアーマー", "プリズムアーマー" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(803, -1, -1, -1, "ベベノム", "", new uint[] { 67, 73, 67, 73, 67, 73 }, (PokeType.Poison, PokeType.None), new string[] { "ビーストブースト", "ビーストブースト", "ビーストブースト" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(807, -1, -1, -1, "ゼラオラ", "", new uint[] { 88, 112, 75, 102, 80, 143 }, (PokeType.Electric, PokeType.None), new string[] { "ちくでん", "ちくでん", "ちくでん" }, GenderRatio.Genderless));
            dexData.Add(new Species(808, -1, -1, -1, "メルタン", "", new uint[] { 46, 65, 65, 55, 35, 34 }, (PokeType.Steel, PokeType.None), new string[] { "じりょく", "じりょく", "じりょく" }, GenderRatio.Genderless));
            dexData.Add(new Species(809, -1, -1, -1, "メルメタル", "", new uint[] { 135, 143, 143, 80, 65, 34 }, (PokeType.Steel, PokeType.None), new string[] { "てつのこぶし", "てつのこぶし", "てつのこぶし" }, GenderRatio.Genderless));
            dexData.Add(new AnotherForm(809, -1, -1, -1, "メルメタル", "キョダイ", new uint[] { 135, 143, 143, 80, 65, 34 }, (PokeType.Steel, PokeType.None), new string[] { "てつのこぶし", "てつのこぶし", "てつのこぶし" }, GenderRatio.Genderless));
            dexData.Add(new Species(810, 1, -1, -1, "サルノリ", "", new uint[] { 50, 65, 50, 40, 40, 65 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "グラスメイカー" }, GenderRatio.M7F1));
            dexData.Add(new Species(811, 2, -1, -1, "バチンキー", "", new uint[] { 70, 85, 70, 55, 60, 80 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "グラスメイカー" }, GenderRatio.M7F1));
            dexData.Add(new Species(812, 3, -1, -1, "ゴリランダー", "", new uint[] { 100, 125, 90, 60, 70, 85 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "グラスメイカー" }, GenderRatio.M7F1));
            dexData.Add(new AnotherForm(812, 3, -1, -1, "ゴリランダー", "キョダイ", new uint[] { 100, 125, 90, 60, 70, 85 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく", "グラスメイカー" }, GenderRatio.M7F1));
            dexData.Add(new Species(813, 4, -1, -1, "ヒバニー", "", new uint[] { 50, 71, 40, 40, 40, 69 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "リベロ" }, GenderRatio.M7F1));
            dexData.Add(new Species(814, 5, -1, -1, "ラビフット", "", new uint[] { 65, 86, 60, 55, 60, 94 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "リベロ" }, GenderRatio.M7F1));
            dexData.Add(new Species(815, 6, -1, -1, "エースバーン", "", new uint[] { 80, 116, 75, 65, 75, 119 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "リベロ" }, GenderRatio.M7F1));
            dexData.Add(new AnotherForm(815, 6, -1, -1, "エースバーン", "キョダイ", new uint[] { 80, 116, 75, 65, 75, 119 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか", "リベロ" }, GenderRatio.M7F1));
            dexData.Add(new Species(816, 7, -1, -1, "メッソン", "", new uint[] { 50, 40, 40, 70, 40, 70 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "スナイパー" }, GenderRatio.M7F1));
            dexData.Add(new Species(817, 8, -1, -1, "ジメレオン", "", new uint[] { 65, 60, 55, 95, 55, 90 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "スナイパー" }, GenderRatio.M7F1));
            dexData.Add(new Species(818, 9, -1, -1, "インテレオン", "", new uint[] { 70, 85, 65, 125, 65, 120 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "スナイパー" }, GenderRatio.M7F1));
            dexData.Add(new AnotherForm(818, 9, -1, -1, "インテレオン", "キョダイ", new uint[] { 70, 85, 65, 125, 65, 120 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう", "スナイパー" }, GenderRatio.M7F1));
            dexData.Add(new Species(819, 24, 9, 5, "ホシガリス", "", new uint[] { 70, 55, 55, 35, 35, 25 }, (PokeType.Normal, PokeType.None), new string[] { "ほおぶくろ", "ほおぶくろ", "くいしんぼう" }, GenderRatio.M1F1));
            dexData.Add(new Species(820, 25, 10, 6, "ヨクバリス", "", new uint[] { 120, 95, 95, 55, 75, 20 }, (PokeType.Normal, PokeType.None), new string[] { "ほおぶくろ", "ほおぶくろ", "くいしんぼう" }, GenderRatio.M1F1));
            dexData.Add(new Species(821, 21, -1, 163, "ココガラ", "", new uint[] { 38, 47, 35, 33, 35, 57 }, (PokeType.Flying, PokeType.None), new string[] { "するどいめ", "きんちょうかん", "はとむね" }, GenderRatio.M1F1));
            dexData.Add(new Species(822, 22, -1, 164, "アオガラス", "", new uint[] { 68, 67, 55, 43, 55, 77 }, (PokeType.Flying, PokeType.None), new string[] { "するどいめ", "きんちょうかん", "はとむね" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(824, 10, 14, -1, "サッチムシ", "", new uint[] { 25, 20, 20, 25, 45, 45 }, (PokeType.Bug, PokeType.None), new string[] { "むしのしらせ", "ふくがん", "テレパシー" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(827, 29, -1, -1, "クスネ", "", new uint[] { 40, 28, 28, 47, 52, 50 }, (PokeType.Dark, PokeType.None), new string[] { "にげあし", "かるわざ", "はりこみ" }, GenderRatio.M1F1));
            dexData.Add(new Species(828, 30, -1, -1, "フォクスライ", "", new uint[] { 70, 58, 58, 87, 92, 90 }, (PokeType.Dark, PokeType.None), new string[] { "にげあし", "かるわざ", "はりこみ" }, GenderRatio.M1F1));
            dexData.Add(new Species(829, 126, -1, 166, "ヒメンカ", "", new uint[] { 40, 40, 60, 40, 60, 10 }, (PokeType.Grass, PokeType.None), new string[] { "わたげ", "さいせいりょく", "ほうし" }, GenderRatio.M1F1));
            dexData.Add(new Species(830, 127, -1, 167, "ワタシラガ", "", new uint[] { 60, 50, 90, 80, 120, 60 }, (PokeType.Grass, PokeType.None), new string[] { "わたげ", "さいせいりょく", "ほうし" }, GenderRatio.M1F1));
            dexData.Add(new Species(831, 34, -1, 3, "ウールー", "", new uint[] { 42, 40, 55, 40, 45, 48 }, (PokeType.Normal, PokeType.None), new string[] { "もふもふ", "にげあし", "ぼうだん" }, GenderRatio.M1F1));
            dexData.Add(new Species(832, 35, -1, 4, "バイウールー", "", new uint[] { 72, 80, 100, 60, 90, 88 }, (PokeType.Normal, PokeType.None), new string[] { "もふもふ", "ふくつのこころ", "ぼうだん" }, GenderRatio.M1F1));
            dexData.Add(new Species(833, 42, 56, -1, "カムカメ", "", new uint[] { 50, 64, 50, 38, 38, 44 }, (PokeType.Water, PokeType.None), new string[] { "がんじょうあご", "シェルアーマー", "すいすい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(835, 46, -1, 155, "ワンパチ", "", new uint[] { 59, 45, 50, 40, 50, 26 }, (PokeType.Electric, PokeType.None), new string[] { "たまひろい", "たまひろい", "びびり" }, GenderRatio.M1F1));
            dexData.Add(new Species(836, 47, -1, 156, "パルスワン", "", new uint[] { 69, 90, 60, 90, 60, 121 }, (PokeType.Electric, PokeType.None), new string[] { "がんじょうあご", "がんじょうあご", "かちき" }, GenderRatio.M1F1));
            dexData.Add(new Species(837, 161, -1, 176, "タンドン", "", new uint[] { 30, 40, 50, 40, 50, 30 }, (PokeType.Rock, PokeType.None), new string[] { "じょうききかん", "たいねつ", "もらいび" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(843, 312, 174, -1, "スナヘビ", "", new uint[] { 52, 57, 75, 35, 50, 46 }, (PokeType.Ground, PokeType.None), new string[] { "すなはき", "だっぴ", "すながくれ" }, GenderRatio.M1F1));
            dexData.Add(new Species(844, 313, 175, -1, "サダイジャ", "", new uint[] { 72, 107, 125, 65, 70, 71 }, (PokeType.Ground, PokeType.None), new string[] { "すなはき", "だっぴ", "すながくれ" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(844, 313, 175, -1, "サダイジャ", "キョダイ", new uint[] { 72, 107, 125, 65, 70, 71 }, (PokeType.Ground, PokeType.None), new string[] { "すなはき", "だっぴ", "すながくれ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(846, 180, 96, -1, "サシカマス", "", new uint[] { 41, 63, 40, 40, 30, 66 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい", "スクリューおびれ" }, GenderRatio.M1F1));
            dexData.Add(new Species(847, 181, 97, -1, "カマスジョー", "", new uint[] { 61, 123, 60, 60, 50, 136 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい", "スクリューおびれ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(852, 351, 129, -1, "タタッコ", "", new uint[] { 50, 68, 60, 50, 50, 32 }, (PokeType.Fighting, PokeType.None), new string[] { "じゅうなん", "じゅうなん", "テクニシャン" }, GenderRatio.M1F1));
            dexData.Add(new Species(853, 352, 130, -1, "オトスパス", "", new uint[] { 80, 118, 90, 70, 80, 42 }, (PokeType.Fighting, PokeType.None), new string[] { "じゅうなん", "じゅうなん", "テクニシャン" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(854, 335, -1, 132, "ヤバチャ", "贋作", new uint[] { 40, 45, 45, 74, 54, 50 }, (PokeType.Ghost, PokeType.None), new string[] { "くだけるよろい", "くだけるよろい", "のろわれボディ" }, GenderRatio.Genderless));
            dexData.Add(new AnotherForm(854, 335, -1, 132, "ヤバチャ", "真作", new uint[] { 40, 45, 45, 74, 54, 50 }, (PokeType.Ghost, PokeType.None), new string[] { "くだけるよろい", "くだけるよろい", "のろわれボディ" }, GenderRatio.Genderless));
            dexData.Add(new AnotherForm(855, 336, -1, 133, "ポットデス", "贋作", new uint[] { 60, 65, 65, 134, 114, 70 }, (PokeType.Ghost, PokeType.None), new string[] { "くだけるよろい", "くだけるよろい", "のろわれボディ" }, GenderRatio.Genderless));
            dexData.Add(new AnotherForm(855, 336, -1, 133, "ポットデス", "真作", new uint[] { 60, 65, 65, 134, 114, 70 }, (PokeType.Ghost, PokeType.None), new string[] { "くだけるよろい", "くだけるよろい", "のろわれボディ" }, GenderRatio.Genderless));
            dexData.Add(new Species(856, 241, -1, 40, "ミブリム", "", new uint[] { 42, 30, 45, 56, 53, 39 }, (PokeType.Psychic, PokeType.None), new string[] { "いやしのこころ", "きけんよち", "マジックミラー" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(857, 242, -1, 41, "テブリム", "", new uint[] { 57, 40, 65, 86, 73, 49 }, (PokeType.Psychic, PokeType.None), new string[] { "いやしのこころ", "きけんよち", "マジックミラー" }, GenderRatio.FemaleOnly));
            ...
            dexData.Add(new Species(863, 183, -1, -1, "ニャイキング", "", new uint[] { 70, 110, 100, 50, 60, 50 }, (PokeType.Steel, PokeType.None), new string[] { "カブトアーマー", "かたいツメ", "はがねのせいしん" }, GenderRatio.M1F1));
            dexData.Add(new Species(864, 237, -1, -1, "サニゴーン", "", new uint[] { 60, 95, 50, 145, 130, 30 }, (PokeType.Ghost, PokeType.None), new string[] { "くだけるよろい", "くだけるよろい", "ほろびのボディ" }, GenderRatio.M1F3));
            dexData.Add(new Species(865, 219, -1, -1, "ネギガナイト", "", new uint[] { 62, 135, 95, 68, 82, 65 }, (PokeType.Fighting, PokeType.None), new string[] { "ふくつのこころ", "ふくつのこころ", "きもったま" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(868, 185, -1, -1, "マホミル", "", new uint[] { 45, 40, 40, 50, 61, 34 }, (PokeType.Fairy, PokeType.None), new string[] { "スイートベール", "スイートベール", "アロマベール" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(869, 186, -1, -1, "マホイップ", "", new uint[] { 65, 60, 75, 110, 121, 64 }, (PokeType.Fairy, PokeType.None), new string[] { "スイートベール", "スイートベール", "アロマベール" }, GenderRatio.FemaleOnly));
            dexData.Add(new AnotherForm(869, 186, -1, -1, "マホイップ", "キョダイ", new uint[] { 65, 60, 75, 110, 121, 64 }, (PokeType.Fairy, PokeType.None), new string[] { "スイートベール", "スイートベール", "アロマベール" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(870, 345, -1, -1, "タイレーツ", "", new uint[] { 65, 100, 100, 70, 60, 75 }, (PokeType.Fighting, PokeType.None), new string[] { "カブトアーマー", "カブトアーマー", "まけんき" }, GenderRatio.Genderless));
            dexData.Add(new Species(871, 353, 126, 158, "バチンウニ", "", new uint[] { 48, 101, 95, 91, 85, 15 }, (PokeType.Electric, PokeType.None), new string[] { "ひらいしん", "ひらいしん", "エレキメイカー" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(874, 369, -1, 89, "イシヘンジン", "", new uint[] { 100, 125, 135, 20, 20, 70 }, (PokeType.Rock, PokeType.None), new string[] { "パワースポット", "パワースポット", "パワースポット" }, GenderRatio.M1F1));
            dexData.Add(new Species(875, 370, -1, 90, "コオリッポ", "", new uint[] { 75, 80, 110, 65, 90, 50 }, (PokeType.Ice, PokeType.None), new string[] { "アイスフェイス", "アイスフェイス", "アイスフェイス" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(878, 302, -1, 108, "ゾウドウ", "", new uint[] { 72, 80, 49, 40, 49, 40 }, (PokeType.Steel, PokeType.None), new string[] { "ちからずく", "ちからずく", "ヘヴィメタル" }, GenderRatio.M1F1));
            dexData.Add(new Species(879, 303, -1, 109, "ダイオウドウ", "", new uint[] { 122, 130, 69, 80, 69, 30 }, (PokeType.Steel, PokeType.None), new string[] { "ちからずく", "ちからずく", "ヘヴィメタル" }, GenderRatio.M1F1));
            dexData.Add(new AnotherForm(879, 303, -1, 109, "ダイオウドウ", "キョダイ", new uint[] { 122, 130, 69, 80, 69, 30 }, (PokeType.Steel, PokeType.None), new string[] { "ちからずく", "ちからずく", "ヘヴィメタル" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(888, 398, -1, -1, "ザシアン", "歴戦の勇者", new uint[] { 92, 130, 115, 80, 115, 138 }, (PokeType.Fairy, PokeType.None), new string[] { "ふとうのけん", "ふとうのけん", "ふとうのけん" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(889, 399, -1, -1, "ザマゼンタ", "歴戦の勇者", new uint[] { 92, 130, 115, 80, 115, 138 }, (PokeType.Fighting, PokeType.None), new string[] { "ふくつのたて", "ふくつのたて", "ふくつのたて" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(891, -1, 100, -1, "ダクマ", "", new uint[] { 60, 90, 60, 53, 50, 72 }, (PokeType.Fighting, PokeType.None), new string[] { "せいしんりょく", "せいしんりょく", "せいしんりょく" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(894, -1, -1, 200, "レジエレキ", "", new uint[] { 80, 100, 50, 100, 50, 200 }, (PokeType.Electric, PokeType.None), new string[] { "トランジスタ", "トランジスタ", "トランジスタ" }, GenderRatio.Genderless));
            dexData.Add(new Species(895, -1, -1, 201, "レジドラゴ", "", new uint[] { 200, 100, 50, 100, 50, 80 }, (PokeType.Dragon, PokeType.None), new string[] { "りゅうのあぎと", "りゅうのあぎと", "りゅうのあぎと" }, GenderRatio.Genderless));
            dexData.Add(new Species(896, -1, -1, 208, "ブリザポス", "", new uint[] { 100, 145, 130, 65, 110, 30 }, (PokeType.Ice, PokeType.None), new string[] { "しろのいななき", "しろのいななき", "しろのいななき" }, GenderRatio.Genderless));
            dexData.Add(new Species(897, -1, -1, 209, "レイスポス", "", new uint[] { 100, 65, 60, 145, 80, 130 }, (PokeType.Ghost, PokeType.None), new string[] { "くろのいななき", "くろのいななき", "くろのいななき" }, GenderRatio.Genderless));
            ...
            dexData.Add(new AnotherForm(898, -1, -1, 210, "バドレックス", "はくば", new uint[] { 100, 165, 150, 85, 130, 50 }, (PokeType.Psychic, PokeType.Ice), new string[] { "じんばいったい", "じんばいったい", "じんばいったい" }, GenderRatio.Genderless));
            dexData.Add(new AnotherForm(898, -1, -1, 210, "バドレックス", "こくば", new uint[] { 100, 85, 80, 165, 100, 150 }, (PokeType.Psychic, PokeType.Ghost), new string[] { "じんばいったい", "じんばいったい", "じんばいったい" }, GenderRatio.Genderless));
