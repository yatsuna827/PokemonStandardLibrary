...
namespace PokemonStandardLibrary.Gen3
{
    public sealed partial class Pokemon
    {
        ...
        static Pokemon()
        {
            ...
            dexData.Add(new Species(4, "ヒトカゲ", "", new uint[] { 39, 52, 43, 60, 50, 65 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(7, "ゼニガメ", "", new uint[] { 44, 48, 65, 50, 64, 43 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(10, "キャタピー", "", new uint[] { 45, 30, 35, 20, 20, 45 }, (PokeType.Bug, PokeType.None), new string[] { "りんぷん", "りんぷん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(19, "コラッタ", "", new uint[] { 30, 56, 35, 25, 35, 72 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "こんじょう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(23, "アーボ", "", new uint[] { 35, 60, 44, 40, 54, 55 }, (PokeType.Poison, PokeType.None), new string[] { "いかく", "だっぴ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(27, "サンド", "", new uint[] { 50, 75, 85, 20, 30, 40 }, (PokeType.Ground, PokeType.None), new string[] { "すながくれ", "すながくれ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(29, "ニドラン♀", "", new uint[] { 55, 47, 52, 40, 40, 41 }, (PokeType.Poison, PokeType.None), new string[] { "どくのトゲ", "どくのトゲ" }, GenderRatio.FemaleOnly));
            ...
            dexData.Add(new Species(32, "ニドラン♂", "", new uint[] { 46, 57, 40, 40, 40, 50 }, (PokeType.Poison, PokeType.None), new string[] { "どくのトゲ", "どくのトゲ" }, GenderRatio.MaleOnly));
            ...
            dexData.Add(new Species(37, "ロコン", "", new uint[] { 38, 41, 40, 50, 65, 65 }, (PokeType.Fire, PokeType.None), new string[] { "もらいび", "もらいび" }, GenderRatio.M1F3));
            ...
            dexData.Add(new Species(50, "ディグダ", "", new uint[] { 10, 55, 25, 35, 45, 95 }, (PokeType.Ground, PokeType.None), new string[] { "すながくれ", "ありじごく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(52, "ニャース", "", new uint[] { 40, 45, 35, 40, 40, 90 }, (PokeType.Normal, PokeType.None), new string[] { "ものひろい", "ものひろい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(54, "コダック", "", new uint[] { 50, 52, 48, 65, 50, 55 }, (PokeType.Water, PokeType.None), new string[] { "しめりけ", "ノーてんき" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(56, "マンキー", "", new uint[] { 40, 80, 35, 35, 45, 70 }, (PokeType.Fighting, PokeType.None), new string[] { "やるき", "やるき" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(58, "ガーディ", "", new uint[] { 55, 70, 45, 70, 50, 60 }, (PokeType.Fire, PokeType.None), new string[] { "いかく", "もらいび" }, GenderRatio.M3F1));
            ...
            dexData.Add(new Species(60, "ニョロモ", "", new uint[] { 40, 50, 40, 40, 40, 90 }, (PokeType.Water, PokeType.None), new string[] { "ちょすい", "しめりけ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(63, "ケーシィ", "", new uint[] { 25, 20, 15, 105, 55, 90 }, (PokeType.Psychic, PokeType.None), new string[] { "シンクロ", "せいしんりょく" }, GenderRatio.M3F1));
            ...
            dexData.Add(new Species(66, "ワンリキー", "", new uint[] { 70, 80, 50, 35, 35, 35 }, (PokeType.Fighting, PokeType.None), new string[] { "こんじょう", "こんじょう" }, GenderRatio.M3F1));
            ...
            dexData.Add(new Species(77, "ポニータ", "", new uint[] { 50, 85, 55, 65, 65, 90 }, (PokeType.Fire, PokeType.None), new string[] { "にげあし", "もらいび" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(86, "パウワウ", "", new uint[] { 65, 45, 55, 45, 70, 45 }, (PokeType.Water, PokeType.None), new string[] { "あついしぼう", "あついしぼう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(88, "ベトベター", "", new uint[] { 80, 80, 50, 40, 50, 25 }, (PokeType.Poison, PokeType.None), new string[] { "あくしゅう", "ねんちゃく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(90, "シェルダー", "", new uint[] { 30, 65, 100, 45, 25, 40 }, (PokeType.Water, PokeType.None), new string[] { "シェルアーマー", "シェルアーマー" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(96, "スリープ", "", new uint[] { 60, 48, 45, 43, 90, 42 }, (PokeType.Psychic, PokeType.None), new string[] { "ふみん", "ふみん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(98, "クラブ", "", new uint[] { 30, 105, 90, 25, 25, 50 }, (PokeType.Water, PokeType.None), new string[] { "かいりきバサミ", "シェルアーマー" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(100, "ビリリダマ", "", new uint[] { 40, 30, 50, 55, 55, 100 }, (PokeType.Electric, PokeType.None), new string[] { "ぼうおん", "せいでんき" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(104, "カラカラ", "", new uint[] { 50, 50, 95, 40, 50, 35 }, (PokeType.Ground, PokeType.None), new string[] { "いしあたま", "ひらいしん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(108, "ベロリンガ", "", new uint[] { 90, 55, 75, 60, 75, 30 }, (PokeType.Normal, PokeType.None), new string[] { "マイペース", "どんかん" }, GenderRatio.M1F1));
            dexData.Add(new Species(109, "ドガース", "", new uint[] { 40, 65, 95, 60, 45, 35 }, (PokeType.Poison, PokeType.None), new string[] { "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(113, "ラッキー", "", new uint[] { 250, 5, 5, 35, 105, 50 }, (PokeType.Normal, PokeType.None), new string[] { "しぜんかいふく", "てんのめぐみ" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(114, "モンジャラ", "", new uint[] { 65, 55, 115, 100, 40, 60 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "ようりょくそ" }, GenderRatio.M1F1));
            dexData.Add(new Species(115, "ガルーラ", "", new uint[] { 105, 95, 80, 40, 80, 90 }, (PokeType.Normal, PokeType.None), new string[] { "はやおき", "はやおき" }, GenderRatio.FemaleOnly));
            dexData.Add(new Species(116, "タッツー", "", new uint[] { 30, 40, 70, 70, 25, 60 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(118, "トサキント", "", new uint[] { 45, 67, 60, 35, 50, 63 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "みずのベール" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(120, "ヒトデマン", "", new uint[] { 30, 45, 55, 70, 55, 85 }, (PokeType.Water, PokeType.None), new string[] { "はっこう", "しぜんかいふく" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(122, "バリヤード", "", new uint[] { 40, 45, 65, 100, 120, 90 }, (PokeType.Psychic, PokeType.None), new string[] { "ぼうおん", "ぼうおん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(127, "カイロス", "", new uint[] { 65, 125, 100, 55, 70, 85 }, (PokeType.Bug, PokeType.None), new string[] { "かいりきバサミ", "かいりきバサミ" }, GenderRatio.M1F1));
            dexData.Add(new Species(128, "ケンタロス", "", new uint[] { 75, 100, 95, 40, 70, 110 }, (PokeType.Normal, PokeType.None), new string[] { "いかく", "いかく" }, GenderRatio.MaleOnly));
            dexData.Add(new Species(129, "コイキング", "", new uint[] { 20, 10, 55, 15, 20, 80 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(133, "イーブイ", "", new uint[] { 55, 55, 50, 45, 65, 55 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "にげあし" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(137, "ポリゴン", "", new uint[] { 65, 60, 70, 85, 75, 40 }, (PokeType.Normal, PokeType.None), new string[] { "トレース", "トレース" }, GenderRatio.Genderless));
            ...
            dexData.Add(new Species(143, "カビゴン", "", new uint[] { 160, 110, 65, 65, 110, 30 }, (PokeType.Normal, PokeType.None), new string[] { "めんえき", "あついしぼう" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(147, "ミニリュウ", "", new uint[] { 41, 64, 45, 50, 50, 50 }, (PokeType.Dragon, PokeType.None), new string[] { "だっぴ", "だっぴ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(152, "チコリータ", "", new uint[] { 45, 49, 65, 49, 65, 45 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(155, "ヒノアラシ", "", new uint[] { 39, 52, 43, 60, 50, 65 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(158, "ワニノコ", "", new uint[] { 50, 65, 64, 44, 48, 43 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(161, "オタチ", "", new uint[] { 35, 46, 34, 35, 45, 20 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "するどいめ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(172, "ピチュー", "", new uint[] { 20, 40, 15, 35, 35, 60 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき" }, GenderRatio.M1F1));
            dexData.Add(new Species(173, "ピィ", "", new uint[] { 50, 25, 28, 45, 55, 15 }, (PokeType.Normal, PokeType.None), new string[] { "メロメロボディ", "メロメロボディ" }, GenderRatio.M1F3));
            dexData.Add(new Species(174, "ププリン", "", new uint[] { 90, 30, 15, 40, 20, 15 }, (PokeType.Normal, PokeType.None), new string[] { "メロメロボディ", "メロメロボディ" }, GenderRatio.M1F3));
            dexData.Add(new Species(175, "トゲピー", "", new uint[] { 35, 20, 65, 40, 65, 20 }, (PokeType.Normal, PokeType.None), new string[] { "はりきり", "てんのめぐみ" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(179, "メリープ", "", new uint[] { 55, 40, 40, 65, 45, 35 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(183, "マリル", "", new uint[] { 70, 20, 50, 20, 50, 40 }, (PokeType.Water, PokeType.None), new string[] { "あついしぼう", "ちからもち" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(185, "ウソッキー", "", new uint[] { 70, 100, 115, 30, 65, 30 }, (PokeType.Rock, PokeType.None), new string[] { "がんじょう", "いしあたま" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(190, "エイパム", "", new uint[] { 55, 70, 55, 40, 55, 85 }, (PokeType.Normal, PokeType.None), new string[] { "にげあし", "ものひろい" }, GenderRatio.M1F1));
            dexData.Add(new Species(191, "ヒマナッツ", "", new uint[] { 30, 30, 30, 30, 30, 30 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "ようりょくそ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(200, "ムウマ", "", new uint[] { 60, 60, 60, 85, 85, 85 }, (PokeType.Ghost, PokeType.None), new string[] { "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new AnotherForm(201, "アンノーン", "?", new uint[] { 48, 72, 48, 72, 48, 48 }, (PokeType.Psychic, PokeType.None), new string[] { "ふゆう", "ふゆう" }, GenderRatio.Genderless));
            dexData.Add(new Species(202, "ソーナンス", "", new uint[] { 190, 33, 58, 33, 58, 33 }, (PokeType.Psychic, PokeType.None), new string[] { "かげふみ", "かげふみ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(204, "クヌギダマ", "", new uint[] { 50, 65, 90, 35, 35, 15 }, (PokeType.Bug, PokeType.None), new string[] { "がんじょう", "がんじょう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(206, "ノコッチ", "", new uint[] { 100, 70, 70, 65, 65, 45 }, (PokeType.Normal, PokeType.None), new string[] { "てんのめぐみ", "にげあし" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(209, "ブルー", "", new uint[] { 60, 80, 50, 40, 40, 30 }, (PokeType.Normal, PokeType.None), new string[] { "いかく", "にげあし" }, GenderRatio.M1F3));
            ...
            dexData.Add(new Species(216, "ヒメグマ", "", new uint[] { 60, 80, 50, 50, 50, 40 }, (PokeType.Normal, PokeType.None), new string[] { "ものひろい", "ものひろい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(218, "マグマッグ", "", new uint[] { 40, 40, 40, 70, 40, 20 }, (PokeType.Fire, PokeType.None), new string[] { "マグマのよろい", "ほのおのからだ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(223, "テッポウオ", "", new uint[] { 35, 65, 35, 65, 35, 65 }, (PokeType.Water, PokeType.None), new string[] { "はりきり", "はりきり" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(231, "ゴマゾウ", "", new uint[] { 90, 60, 60, 40, 40, 40 }, (PokeType.Ground, PokeType.None), new string[] { "ものひろい", "ものひろい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(234, "オドシシ", "", new uint[] { 73, 95, 62, 85, 65, 85 }, (PokeType.Normal, PokeType.None), new string[] { "いかく", "いかく" }, GenderRatio.M1F1));
            dexData.Add(new Species(235, "ドーブル", "", new uint[] { 55, 20, 35, 20, 45, 75 }, (PokeType.Normal, PokeType.None), new string[] { "マイペース", "マイペース" }, GenderRatio.M1F1));
            dexData.Add(new Species(236, "バルキー", "", new uint[] { 35, 35, 35, 35, 35, 35 }, (PokeType.Fighting, PokeType.None), new string[] { "こんじょう", "こんじょう" }, GenderRatio.MaleOnly));
            ...
            dexData.Add(new Species(239, "エレキッド", "", new uint[] { 45, 63, 37, 65, 55, 95 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "せいでんき" }, GenderRatio.M3F1));
            dexData.Add(new Species(240, "ブビィ", "", new uint[] { 45, 75, 37, 70, 55, 83 }, (PokeType.Fire, PokeType.None), new string[] { "ほのおのからだ", "ほのおのからだ" }, GenderRatio.M3F1));
            dexData.Add(new Species(241, "ミルタンク", "", new uint[] { 95, 80, 105, 40, 70, 100 }, (PokeType.Normal, PokeType.None), new string[] { "あついしぼう", "あついしぼう" }, GenderRatio.FemaleOnly));
            ...
            dexData.Add(new Species(252, "キモリ", "", new uint[] { 40, 45, 35, 65, 55, 70 }, (PokeType.Grass, PokeType.None), new string[] { "しんりょく", "しんりょく" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(255, "アチャモ", "", new uint[] { 45, 60, 40, 70, 50, 45 }, (PokeType.Fire, PokeType.None), new string[] { "もうか", "もうか" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(258, "ミズゴロウ", "", new uint[] { 50, 70, 50, 50, 50, 40 }, (PokeType.Water, PokeType.None), new string[] { "げきりゅう", "げきりゅう" }, GenderRatio.M7F1));
            ...
            dexData.Add(new Species(261, "ポチエナ", "", new uint[] { 35, 55, 35, 30, 30, 35 }, (PokeType.Dark, PokeType.None), new string[] { "にげあし", "にげあし" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(263, "ジグザグマ", "", new uint[] { 38, 30, 41, 30, 41, 60 }, (PokeType.Normal, PokeType.None), new string[] { "ものひろい", "ものひろい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(265, "ケムッソ", "", new uint[] { 45, 45, 35, 20, 30, 20 }, (PokeType.Bug, PokeType.None), new string[] { "りんぷん", "りんぷん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(273, "タネボー", "", new uint[] { 40, 40, 50, 30, 30, 30 }, (PokeType.Grass, PokeType.None), new string[] { "ようりょくそ", "はやおき" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(280, "ラルトス", "", new uint[] { 28, 25, 25, 45, 35, 40 }, (PokeType.Psychic, PokeType.None), new string[] { "シンクロ", "トレース" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(285, "キノココ", "", new uint[] { 60, 40, 60, 40, 60, 35 }, (PokeType.Grass, PokeType.None), new string[] { "ほうし", "ほうし" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(287, "ナマケロ", "", new uint[] { 60, 60, 60, 35, 35, 30 }, (PokeType.Normal, PokeType.None), new string[] { "なまけ", "なまけ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(293, "ゴニョニョ", "", new uint[] { 64, 51, 23, 51, 23, 28 }, (PokeType.Normal, PokeType.None), new string[] { "ぼうおん", "ぼうおん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(296, "マクノシタ", "", new uint[] { 72, 60, 30, 20, 30, 25 }, (PokeType.Fighting, PokeType.None), new string[] { "あついしぼう", "こんじょう" }, GenderRatio.M3F1));
            ...
            dexData.Add(new Species(298, "ルリリ", "", new uint[] { 50, 20, 40, 20, 40, 20 }, (PokeType.Normal, PokeType.None), new string[] { "あついしぼう", "ちからもち" }, GenderRatio.M1F3));
            dexData.Add(new Species(299, "ノズパス", "", new uint[] { 30, 45, 135, 45, 90, 30 }, (PokeType.Rock, PokeType.None), new string[] { "がんじょう", "じりょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(300, "エネコ", "", new uint[] { 50, 45, 45, 35, 35, 50 }, (PokeType.Normal, PokeType.None), new string[] { "メロメロボディ", "メロメロボディ" }, GenderRatio.M1F3));
            ...
            dexData.Add(new Species(303, "クチート", "", new uint[] { 50, 85, 85, 55, 55, 50 }, (PokeType.Steel, PokeType.None), new string[] { "かいりきバサミ", "いかく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(309, "ラクライ", "", new uint[] { 40, 45, 40, 65, 40, 65 }, (PokeType.Electric, PokeType.None), new string[] { "せいでんき", "ひらいしん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(311, "プラスル", "", new uint[] { 60, 50, 40, 85, 75, 95 }, (PokeType.Electric, PokeType.None), new string[] { "プラス", "プラス" }, GenderRatio.M1F1));
            dexData.Add(new Species(312, "マイナン", "", new uint[] { 60, 40, 50, 75, 85, 95 }, (PokeType.Electric, PokeType.None), new string[] { "マイナス", "マイナス" }, GenderRatio.M1F1));
            dexData.Add(new Species(313, "バルビート", "", new uint[] { 65, 73, 55, 47, 75, 85 }, (PokeType.Bug, PokeType.None), new string[] { "はっこう", "むしのしらせ" }, GenderRatio.MaleOnly));
            dexData.Add(new Species(314, "イルミーゼ", "", new uint[] { 65, 47, 55, 73, 75, 85 }, (PokeType.Bug, PokeType.None), new string[] { "どんかん", "どんかん" }, GenderRatio.FemaleOnly));
            ...
            dexData.Add(new Species(316, "ゴクリン", "", new uint[] { 70, 43, 53, 43, 53, 40 }, (PokeType.Poison, PokeType.None), new string[] { "ヘドロえき", "ねんちゃく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(320, "ホエルコ", "", new uint[] { 130, 70, 35, 70, 35, 60 }, (PokeType.Water, PokeType.None), new string[] { "みずのベール", "どんかん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(324, "コータス", "", new uint[] { 70, 85, 140, 85, 70, 20 }, (PokeType.Fire, PokeType.None), new string[] { "しろいけむり", "しろいけむり" }, GenderRatio.M1F1));
            dexData.Add(new Species(325, "バネブー", "", new uint[] { 60, 25, 35, 70, 80, 60 }, (PokeType.Psychic, PokeType.None), new string[] { "あついしぼう", "マイペース" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(327, "パッチール", "", new uint[] { 60, 60, 60, 60, 60, 60 }, (PokeType.Normal, PokeType.None), new string[] { "マイペース", "マイペース" }, GenderRatio.M1F1));
            dexData.Add(new Species(328, "ナックラー", "", new uint[] { 45, 100, 45, 45, 45, 10 }, (PokeType.Ground, PokeType.None), new string[] { "かいりきバサミ", "ありじごく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(331, "サボネア", "", new uint[] { 50, 85, 40, 85, 40, 35 }, (PokeType.Grass, PokeType.None), new string[] { "すながくれ", "すながくれ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(335, "ザングース", "", new uint[] { 73, 115, 60, 60, 60, 90 }, (PokeType.Normal, PokeType.None), new string[] { "めんえき", "めんえき" }, GenderRatio.M1F1));
            dexData.Add(new Species(336, "ハブネーク", "", new uint[] { 73, 100, 60, 100, 60, 65 }, (PokeType.Poison, PokeType.None), new string[] { "だっぴ", "だっぴ" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(341, "ヘイガニ", "", new uint[] { 43, 80, 65, 50, 35, 35 }, (PokeType.Water, PokeType.None), new string[] { "かいりきバサミ", "シェルアーマー" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(349, "ヒンバス", "", new uint[] { 20, 15, 20, 10, 55, 80 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(351, "ポワルン", "", new uint[] { 70, 70, 70, 70, 70, 70 }, (PokeType.Normal, PokeType.None), new string[] { "てんきや", "てんきや" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(352, "カクレオン", "", new uint[] { 60, 90, 70, 60, 120, 40 }, (PokeType.Normal, PokeType.None), new string[] { "へんしょく", "へんしょく" }, GenderRatio.M1F1));
            dexData.Add(new Species(353, "カゲボウズ", "", new uint[] { 44, 75, 35, 63, 33, 45 }, (PokeType.Ghost, PokeType.None), new string[] { "ふみん", "ふみん" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(355, "ヨマワル", "", new uint[] { 20, 40, 90, 30, 90, 25 }, (PokeType.Ghost, PokeType.None), new string[] { "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(358, "チリーン", "", new uint[] { 65, 50, 70, 95, 80, 65 }, (PokeType.Psychic, PokeType.None), new string[] { "ふゆう", "ふゆう" }, GenderRatio.M1F1));
            dexData.Add(new Species(359, "アブソル", "", new uint[] { 65, 130, 60, 75, 60, 75 }, (PokeType.Dark, PokeType.None), new string[] { "プレッシャー", "プレッシャー" }, GenderRatio.M1F1));
            dexData.Add(new Species(360, "ソーナノ", "", new uint[] { 95, 23, 48, 23, 48, 23 }, (PokeType.Psychic, PokeType.None), new string[] { "かげふみ", "かげふみ" }, GenderRatio.M1F1));
            dexData.Add(new Species(361, "ユキワラシ", "", new uint[] { 50, 50, 50, 50, 50, 50 }, (PokeType.Ice, PokeType.None), new string[] { "せいしんりょく", "せいしんりょく" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(366, "パールル", "", new uint[] { 35, 64, 85, 74, 55, 32 }, (PokeType.Water, PokeType.None), new string[] { "シェルアーマー", "シェルアーマー" }, GenderRatio.M1F1));
            ...
            dexData.Add(new Species(370, "ラブカス", "", new uint[] { 43, 30, 55, 40, 65, 97 }, (PokeType.Water, PokeType.None), new string[] { "すいすい", "すいすい" }, GenderRatio.M1F3));
            dexData.Add(new Species(371, "タツベイ", "", new uint[] { 45, 75, 60, 40, 30, 50 }, (PokeType.Dragon, PokeType.None), new string[] { "いしあたま", "いしあたま" }, GenderRatio.M1F1));
